...
typedef enum _T_eEtherCAT_ProductCode
{
    ...
    /* fine */
    ecprodcode_fine_serial                      = 0x12345678,
    ecprodcode_fine_stocker_io                  = 0x00000010,
    ecprodcode_fine_oht_front                   = 0x00000011,
    ecprodcode_fine_oht_rear                    = 0x00000012,
