...
#define ATEMRASSRV_VERS_SERVICEPACK     2       /* service pack  */  
#define ATEMRASSRV_VERS_BUILD           27          /* build number  */  
...
#define ATEMRASSRV_FILEVERSION     1,9,2,27 
#define ATEMRASSRV_FILEVERSIONSTR  "1.9.2.27\0" 
