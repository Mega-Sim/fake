...
typedef EC_T_DWORD (*EC_PF_HW_TIMER_GET_CURRENT_COUNT)(EC_T_INT* pnCountPermil);
...
#    define OsTscMeasDisableIrq(pTscMeasDesc,dwIndex)  { __asm volatile ("cpsid i" : : : "memory");};
#    define OsTscMeasEnableIrq(pTscMeasDesc,dwIndex)   { __asm volatile ("cpsie i" : : : "memory"); };
#  else
