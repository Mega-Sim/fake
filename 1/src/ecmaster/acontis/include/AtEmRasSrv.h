...
#define RASSPOCCFGINITDEFAULT \
    ...
    /*  call class, min. access,            ordinal,                        index ,                                                      subindex,           cse=0 */ \
        ...
        0x00000001, rasal_freeaccess,       ord_emAoeWriteControl,          PARAMETER_IGNORE,                                            PARAMETER_IGNORE,   0x00000000,  \
        /* end of list entry */ \
        ...
        0x00000001, rasal_freeaccess,       ord_emIoControl,                EC_IOCTL_SET_ZERO_INPUTS_ON_WKC_ZERO,                        PARAMETER_IGNORE,   0x00000000, /* emIoControl(EC_IOCTL_SET_ZERO_INPUTS_ON_WKC_ZERO), free access */ \
        0x00000001, rasal_freeaccess,       ord_emIoControl,                EC_IOCTL_SET_ZERO_INPUTS_ON_WKC_ERROR,                       PARAMETER_IGNORE,   0x00000000, /* emIoControl(EC_IOCTL_SET_ZERO_INPUTS_ON_WKC_ERROR), free access */ \
        ...
        0x00000001, rasal_freeaccess,       ord_emIoControl,                EC_IOCTL_DC_ENABLE_ALL_DC_SLV,                               PARAMETER_IGNORE,   0x00000000, /* emIoControl(EC_IOCTL_DC_ENABLE_ALL_DC_SLV), free access */ \
