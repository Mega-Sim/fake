...
#define ecatCoeSdoDownloadEx(dwSlaveId, wObIndex, byObSubIndex, pbyData, dwDataLen, dwTimeout, dwFlags) \
    (sephi::the_ec_emulator.get()->emulationMode() ?  sephi::the_ec_emulator.get()->coeSdoDownload(dwSlaveId, wObIndex, byObSubIndex, pbyData, dwDataLen, dwFlags) \
        : ecatCoeSdoDownload(dwSlaveId, wObIndex, byObSubIndex, pbyData, dwDataLen, dwTimeout, dwFlags))

#define ecatCoeSdoUploadEx(dwSlaveId, wObIndex, byObSubIndex, pbyData, dwDataLen, pdwOutDataLen, dwTimeout, dwFlags) \
    (sephi::the_ec_emulator.get()->emulationMode() ?  sephi::the_ec_emulator.get()->coeSdoUpload(dwSlaveId, wObIndex, byObSubIndex, pbyData, dwDataLen, pdwOutDataLen, dwFlags) \
        : ecatCoeSdoUpload(dwSlaveId, wObIndex, byObSubIndex, pbyData, dwDataLen, pdwOutDataLen, dwTimeout, dwFlags))
...
typedef struct _EC_T_DCM_CONFIG_BUSSHIFT
{
    ...
    EC_T_BOOL       bUseDcLoopCtlStdValues;     /*< [in] EC_TRUE don´t change values of ESC DC time loop control register 0x930 and 0x934 */
