...
#define EC_LINK_PARMS_SIGNATURE_GEM_VERSION (EC_T_DWORD)0x00000004
...
{
    eDW3504_LCES1    = 0, /* MAC on LCES1 SoC */
    eDW3504_CycloneV = 1, /* MAC on Cyclone V SoC */
...
/*****************************************************************************/
#define EC_LINK_PARMS_SIGNATURE_ALTERATSE_PATTERN (EC_T_DWORD)0x0000CB60
...
/* XMC                                                                         */
/*****************************************************************************/
#define EC_LINK_PARMS_SIGNATURE_XMC_PATTERN (EC_T_DWORD)0x0000CB50
#define EC_LINK_PARMS_SIGNATURE_XMC_VERSION (EC_T_DWORD)0x00000001
#define EC_LINK_PARMS_SIGNATURE_XMC (EC_T_DWORD)(EC_LINK_PARMS_SIGNATURE|EC_LINK_PARMS_SIGNATURE_XMC_PATTERN|EC_LINK_PARMS_SIGNATURE_XMC_VERSION)
#define EC_LINK_PARMS_IDENT_XMC "XMC"

#include EC_PACKED_INCLUDESTART(8)
typedef struct _EC_T_LINK_PARMS_XMC
{
    /**
     * \brief Link Layer abstraction.
     * set linkParms.dwSignature = EC_LINK_PARMS_SIGNATURE_XMC
     *
     * Must be first, see casts in usage.
     */
    EC_T_LINK_PARMS linkParms;
...
} EC_PACKED(8) EC_T_LINK_PARMS_XMC;
#include EC_PACKED_INCLUDESTOP
