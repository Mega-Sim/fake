...
#ifndef LogError
#define LogError    SEP_LOGE
#endif
#ifndef LogErrorAdd
#define LogErrorAdd SEP_LOGE
#endif
#ifndef LogMsg
#define LogMsg      SEP_LOGT
#endif
    ...
    case EC_NOTIFY_SB_STATUS:   /* GEN|3 */
        {
            ...
            if (EC_E_NOERROR != dwRes)
            {
                ...
                the_EcMasterSvc_ins->stopAllServo();
            }
        } break;
    ...
    case EC_NOTIFY_SLAVE_PRESENCE:      /* GEN|101 */
        {
            if (pNotificationDesc->desc.SlavePresenceDesc.bPresent)
            {
                ...
                the_EcMasterSvc_ins->changeSlavePresentState(true);
            }
            else
            {
                LogMsg(ecatGetText(EC_TXT_SLAVE_ABSENT), pNotificationDesc->desc.SlavePresenceDesc.wStationAddress);
                the_EcMasterSvc_ins->changeSlavePresentState(false);
                the_EcMasterSvc_ins->setAllServoIntoFault();
            }
        } break;
