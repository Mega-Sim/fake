...
#ifndef ClwPassConfirmStatusReportH
#define ClwPassConfirmStatusReportH
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
#include <Grids.hpp>
//---------------------------------------------------------------------------
class TfrmClwPassConfirmStatusReport : public TForm
{
...
public:		// User declarations
	__fastcall TfrmClwPassConfirmStatusReport(TComponent* Owner);
};
//---------------------------------------------------------------------------
extern PACKAGE TfrmClwPassConfirmStatusReport *frmClwPassConfirmStatusReport;
//---------------------------------------------------------------------------
#endif
