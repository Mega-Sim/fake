...
#ifndef ClwPassConfirmRequestH
#define ClwPassConfirmRequestH
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
//---------------------------------------------------------------------------
class TfrmClwPassConfirmRequest : public TForm
{
...
public:		// User declarations
	__fastcall TfrmClwPassConfirmRequest(TComponent* Owner);
};
//---------------------------------------------------------------------------
extern PACKAGE TfrmClwPassConfirmRequest *frmClwPassConfirmRequest;
//---------------------------------------------------------------------------
#endif
