...
#define SOS_OBS_Frame_Data_Size  4036	//test 추후 삭제
...
public:
	...
	bool CheckError();
	int OpenCom(void);
	bool IsConnect(); //OBS ComOpen 상태에서  오토 체인지 필요한 경우에 OBS Comclose 위해
...
//	int GetSensorLevel(bool bLong, bool bMiddle, bool bShort, bool bFail); //soming OBS 패턴 USER_LOG 추가      //미사용
	int GetSensorLevel_MCC();
   //	int GetOutputSensorLevel(bool bSel1, bool bSel2, bool bSel3, bool bSel4, bool bPower);
//	AnsiString GetOutputSensorLevel(bool bSel1, bool bSel2, bool bSel3, bool bSel4, bool bPower);           //미사용
	...
	int CheckOBSConnect(bool bDisConnect); //AOHC-256 AutoMode 시 UBG Fiemware 실행 불가
