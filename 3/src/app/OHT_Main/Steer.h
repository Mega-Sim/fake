...
public:
    ...
    int SendLeftCmd();
    int SendRightCmd();
//    int SendLeftCmdWeakly();                                     //미사용
//	int SendRightCmdWeakly();                                      //미사용
	int Stop();
//	int Resume();                                                  //미사용
	int SendTractionLeftCmd();
	int SendTractionRightCmd();
//	int FrontLeftStop();                                           //미사용
//	int RearLeftStop();                                            //미사용
//	int FrontRightStop();                                          //미사용
//	int RearRightStop();                                           //미사용
	int FrontFree();
    int RearFree();
    int FrontEnable();
    int RearEnable();
...
//	bool IsLeftCmd(int nFrontRear);                                 //미사용
//	bool IsRightCmd(int nFrontRear);                                //미사용
//    int Check_Steering_Torque(bool bResetCount);                    //미사용
    ...
    bool IsRearRightOn();
	bool IsFTorque0On();
//	bool IsFTorque1On();                                            //미사용
	bool IsRTorque0On();
//	bool IsRTorque1On();                                            //미사용
	bool IsFDirOn();
	bool IsRDirOn();
