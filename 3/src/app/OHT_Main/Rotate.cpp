...
int Rotate::GetRunningCount()
{
	return nCheckMotorRunningCount;
}

void Rotate::SetRunningCount()
{
	nCheckMotorRunningCount++;
}

void Rotate::ClearRunningCount()
{
	nCheckMotorRunningCount=0;
}
