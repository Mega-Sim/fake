...
#define IOT_H_LEN_MODEL_TYPE		2
#define IOT_H_LEN_OHT_NO	 		6
#define IOT_H_LEN_LINE_INFO	 		32
#define IOT_H_LEN_OHT_ERRORCODE	 	4
#define IOT_H_LEN_OHT_RESERVED	 	4
...
// 	IOT_HEADER GetIotHeader(char *pBuffer, int *nBuffOffset);       //미사용
...
*/
	...
	void SetOHTModelTypeInfo(BYTE cModel, BYTE cType);
};
