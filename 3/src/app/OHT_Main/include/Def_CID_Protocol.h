...
//#define CID_SERIAL_CMD_DELAY_TURN		10	// 5 - error. 7 - success.  기존 10
...
#define LIGHT_GUIDE_ID_INPUT_ENTER			'E'
#define LIGHT_GUIDE_ID_INPUT_UP				'H'
#define LIGHT_GUIDE_ID_INPUT_DOWN			'L' //변경 필요 'L'
#define LIGHT_GUIDE_ID_INPUT_MTL			'Y'
#define LIGHT_GUIDE_ID_INPUT_AUTODOOR		'A' //변경 필요 'A'
#define LIGHT_GUIDE_ID_INPUT_UP_PRE			'x' // AOHC-217 VHLLifter 속도 개선 by jhoun.lim 2018.06.04   //미사용
#define LIGHT_GUIDE_ID_INPUT_DOWN_PRE		'y' // AOHC-217 VHLLifter 속도 개선 by jhoun.lim 2018.06.04   //미사용
#define LIGHT_GUIDE_ID_NONE					'N' // AOHC-217 VHLLifter 속도 개선 by jhoun.lim 2018.06.04   //미사용
