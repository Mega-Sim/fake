...
*/
	...
	MTL_AREA            = 0x24,      ///< MTL Area    AOHC-409

	AUTODOOR_LEFT       = 0x30,     ///< AutoDoor Left Node
	AUTODOOR_RIGHT      = 0x31,     ///< AutoDoor Right Node

	FDConnectedType     = 0x40,      ///< FireDoor 연결형 속도 3.3m/s       AOHC-409
	FDDisconnectedType  = 0x41,      ///< FireDoor 절단형 속도 1.0m/s       AOHC-409

	EmergencyNodeMTL_NTYPE	= 0xE0,		///< 진입/이동 불가 EmergencyNodeMTL
...
typedef enum MARK_TYPE_
{
	...
	MARK_TYPE_OFFSET  	 		= 4,
	MARK_TYPE_QR_LEFT_TOP		= 5,
	MARK_TYPE_QR_LEFT_BOTTOM	= 6,
	MARK_TYPE_QR_RIGHT_TOP		= 7,
	MARK_TYPE_QR_RIGHT_BOTTOM	= 8,
	MARK_TYPE_QR_LEFT_BOTTOM_S	= 9,
	MARK_TYPE_QR_RIGHT_BOTTOM_S	= 10,
	MARK_TYPE_QR_PSTB_LEFT		= 11,
	MARK_TYPE_QR_PSTB_RIGHT		= 12,
	MARK_TYPE_TAG_STATION_BACK	= 13			///< TRANS_POINT_TAG = 이적재 TAG
}MARK_TYPE;
