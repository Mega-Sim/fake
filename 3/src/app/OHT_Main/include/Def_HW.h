...
/**
@brief   Input Bit Field 구조    //Hand TP용  개선 필요
         Input 0~63
@author  zzang9un
@date    2012.11.26
*/
typedef struct sINPUT_BITFIELD_
{
	...
	UINT64 EQPIO_Right_Go          : 1; // 14
	UINT64 EQPIO_Left_Go           : 1; // 15
...
typedef struct sRETICLEINPUT_
{
	...
	BYTE Rotate_270_Sensor;
	BYTE HOIST_Home;
	BYTE Reverved_75;           //AOHC-286
	BYTE Reverved_76;           //AOHC-286
	BYTE Reverved_77;           //AOHC-286
	BYTE Reverved_78;           //AOHC-286
...
typedef struct sSTANDARDINPUT_V86_
{
	// 10개(No mapping)
	BYTE HAND_Inposition;
	BYTE HAND_Alarm;
...
typedef struct sSTANDARDINPUT_V85S_
{
// 10개(No mapping)
	BYTE HAND_Inposition;
	BYTE HAND_Alarm;
...
typedef struct sSTANDARDINPUT_V82_
{
// 10개(No mapping)
	BYTE HAND_Inposition;
	BYTE HAND_Alarm;
...
///mgchoi 2022-08-18. P4 Mask용 Input 정의
#elif(OHT_NAME == OHT_NAME_P4_MASK)
typedef struct sMASKINPUT_
{
	BYTE HAND_Flange_Check;
	BYTE HAND_Alarm;
	BYTE HAND_Right_Grip;
	BYTE HAND_Left_Grip;
	BYTE HAND_Work;
	...
	BYTE HAND_ES;					//HAND_PIO_Go
	BYTE HAND_PIO_Go;				//EQPIO_Load_REQ;

	BYTE EQPIO_Load_REQ;			//EQPIO_Unload_REQ;
	BYTE EQPIO_Unload_REQ;			//EQPIO_Ready;
	BYTE EQPIO_Ready;				//EQPIO_HO_AVBL;
	BYTE EQPIO_HO_AVBL;				//EQPIO_ES;
	BYTE EQPIO_ES;					//EQPIO_Left_Go;
	BYTE EQPIO_Right_Go;				//EQPIO_Right_Go;
	BYTE EQPIO_Left_Go;			//STEER_F_Left;

	BYTE STEER_F_Left;				//STEER_R_Left;
	BYTE STEER_R_Left;				//STEER_F_Right;
	BYTE STEER_F_Right;				//STEER_R_Right;
	BYTE STEER_R_Right;				//SHUTTER_F_Close;

	BYTE SHUTTER_F_Close;			//Reserved_22;
	BYTE ANTIDROP_POD_Placement1;	//SHUTTER_F_Open;
	BYTE SHUTTER_F_Open;			//Reserved_24;
	BYTE ANTIDROP_POD_Placement2;	//SHUTTER_F_Alarm;
	BYTE SHUTTER_F_Alarm;			//Reserved_26;
	BYTE Reserved_27;				//SHUTTER_F_Inposition;
	BYTE SHUTTER_F_Inposition;		//Reserved_28;
	BYTE Reserved_29;				//OBSTACLE_Long;
	BYTE Reserved_30;				//OBSTACLE_Middle;

	BYTE OBSTACLE_Long;				//OBSTACLE_Short;
	BYTE OBSTACLE_Middle;			//OBSTACLE_Fail;
	BYTE OBSTACLE_Short;			//OHTDETECT_Long;
	BYTE OBSTACLE_Fail;				//OHTDETECT_Middle;
	BYTE Reserved_35;				//OHTDETECT_Short;

	BYTE OHTDETECT_Long;			//OHTDETECT_Fail;
	BYTE OHTDETECT_Middle;			//LOOKDOWN_Detect;
	BYTE OHTDETECT_Short;			//LOOKDOWN_Error;
	BYTE OHTDETECT_Fail;			//SHIFT_Home;

	BYTE LOOKDOWN_Detect;			//STB_Detect_Left;
	BYTE LOOKDOWN_Error;			//STB_Detect_Right;

	BYTE FFU_Fail_Hoist;			//UTB_Detect;
	BYTE Reserved_43;				//FOUP_Detect;
	BYTE Reserved_44;				//OSCILLATION;
	BYTE UTB_Detect;				//EMO_Press;
	BYTE EUVPod_Detect;				//BUMPER_Press;
	BYTE OSCILLATION;				//FAN_Fail;
	BYTE EMO_Press;					//HOIST_Home;
	BYTE BUMPER_Press;				//MC_Status;
	BYTE FFU_Fail_Frame;			//HANDTP_Connect;

	BYTE Slide_Neg_Limit;			//HOIST_LowerHome;
	BYTE Reserved_52;				//STOP_Driving_Front;
	BYTE Reserved_53;				//STOP_Driving_PreCheck;
	BYTE RSP200_Detect;				//STOP_Trans_Front;

	BYTE STOP_Driving_Front;		//STOP_Trans_Rear;
	BYTE STOP_Driving_PreCheck;		//BCR_Driving_OK;
	BYTE STOP_Trans_Front;			//BCR_Driving_NG;
	BYTE STOP_Trans_Rear;			//BCR_Trans_OK;
	BYTE BCR_Driving_OK;			//BCR_Trans_NG;
	BYTE BCR_Driving_NG;			//FFU_Fail;
	BYTE BCR_Trans_OK;				//ANTIDROP_POD_Placement1;
	BYTE BCR_Trans_NG;				//ANTIDROP_POD_Placement2;

	BYTE Slide_Pos_Limit;			//Reserved_63;
	BYTE Reserved_64;				//SMPS_Short;
	BYTE Reserved_65;				//Reserved_65;
	BYTE Reserved_66;				//Reserved_66;
	BYTE SMPS_Short;				//Reserved_67;

	BYTE HOIST_Home;				//Reserved_68;
	BYTE EUVPod_Home;				//Reserved_69;
	BYTE RSP200_Home;				//Reserved_70;
	BYTE RSP150_Home;				//Reserved_71;
	BYTE Reserved_72;				//Reserved_72;

	BYTE Reserved_73;				//HAND_Inposition;
	BYTE SHIFT_Home;				//HAND_Close;
	BYTE Reserved_75;				//HAND_Open;
	BYTE Reserved_76;				//HAND_Push;
	BYTE Reserved_77;				//SHUTTER_R_Close;
	BYTE POD_Detect;				//SHUTTER_R_Open;
	BYTE RSP150_Detect;				//SHUTTER_R_Alarm;
	BYTE ANTIDROP_POD_Placement3;	//SHUTTER_R_Inposition;
	BYTE ANTIDROP_POD_Placement4;	//SHUTTER_R_Open;
...
#elif(OHT_NAME == OHT_NAME_STD_V86)
typedef struct sSTANDARDOUTPUT_V86_
{
	//10개
	BYTE HAND_Close;
	BYTE HAND_Open;
...
#elif(OHT_NAME == OHT_NAME_STD_V85S)
typedef struct sSTANDARDOUTPUT_V85S_
{
...
}sSTANDARDOUTPUT_V85S;

#elif(OHT_NAME == OHT_NAME_STD_V82)
typedef struct sSTANDARDOUTPUT_V82_
{
...
///mgchoi 2022-08-18. P4 Mask용 Output 정의
#elif(OHT_NAME == OHT_NAME_P4_MASK)
typedef struct sMASKOUTPUT_          // OHT_NAME_P4_MASK
{
	BYTE HAND_Work;
	...
	BYTE HAND_Free;
	BYTE HAND_Reserved8;
	BYTE HAND_Reserved9;			//HAND_PIO_Select;
	BYTE HAND_PIO_Select;			//EQPIO_Valid;

	BYTE EQPIO_Valid;				//EQPIO_CS_0;
	BYTE EQPIO_CS_0;				//EQPIO_CS_1;
	BYTE EQPIO_CS_1;				//EQPIO_Reserved13;
	BYTE EQPIO_CS_2;				//EQPIO_Reserved14;
	BYTE EQPIO_CS_3;				//EQPIO_TR_Req;
	BYTE EQPIO_TR_Req;				//EQPIO_Busy;
	BYTE EQPIO_Busy;				//EQPIO_Complete;
	BYTE EQPIO_Complete;			//EQPIO_Right_Select;
	BYTE EQPIO_Right_Select;		//EQPIO_Left_Select;
	BYTE EQPIO_Left_Select;			//STEER_F_TRQ_0;

	BYTE STEER_F_TRQ_0;				//STEER_F_TRQ_1;
	BYTE STEER_F_TRQ_1;				//STEER_R_TRQ_0;
	BYTE STEER_R_TRQ_0;				//STEER_R_TRQ_1;
	BYTE STEER_R_TRQ_1;				//STEER_F_Dir;
	BYTE STEER_F_Dir;				//STEER_R_Dir;
	BYTE STEER_R_Dir;				//SHUTTER_F_Reset;

	BYTE SHUTTER_F_Reset;			//Reserved27;
	BYTE Reserved_28;				//SHUTTER_F_Close;
	BYTE SHUTTER_F_Close;			//Reserved29;
	BYTE Reserved_30;				//SHUTTER_F_Open;
	BYTE SHUTTER_F_Open;			//Reserved31;
	BYTE Reserved_32;				//SHUTTER_F_Origin;
	BYTE SHUTTER_F_Origin;			//Reserved33;
	BYTE Reserved_34;				//SHUTTER_F_Free;
	BYTE SHUTTER_F_Free;			//Reserved35;
	BYTE Reserved_36;				//OBSTACLE_Area1_Sel;

	BYTE OBSTACLE_Area1_Sel;		//OBSTACLE_Area2_Sel;
	BYTE OBSTACLE_Area2_Sel;		//OBSTACLE_Area3_Sel;
	BYTE OBSTACLE_Area3_Sel;		//OBSTACLE_Area4_Sel;
	BYTE OBSTACLE_Area4_Sel;		//OBSTACLE_Power_Reset;
	BYTE Reserved_41;				//OHTDETECT_Area1_Sel;
	BYTE OBSTACLE_Power_Reset;		//OHTDETECT_Area2_Sel;

	BYTE OHTDETECT_Area1_Sel;		//OHTDETECT_Area3_Sel;
	BYTE OHTDETECT_Area2_Sel;		//OHTDETECT_Area4_Sel;
	BYTE OHTDETECT_Area3_Sel;		//OHTDETECT_Power_Reset;
	BYTE OHTDETECT_Area4_Sel;		//LOOKDOWN_Area1_Sel;
	BYTE Reserved_47;				//LOOKDOWN_Area2_Sel;
	BYTE OHTDETECT_Power_Reset;		//LOOKDOWN_Area3_Sel;

	BYTE LOOKDOWN_Area1_Sel;		//LOOKDOWN_Area4_Sel;
	BYTE LOOKDOWN_Area2_Sel;		//LOOKDOWN_Power_Reset;
	BYTE LOOKDOWN_Area3_Sel;		//LAMP_Red;
	BYTE LOOKDOWN_Area4_Sel;		//LAMP_Yellow;
	BYTE LOOKDOWN_Power_Reset;		//LAMP_Green;

	BYTE LAMP_Red_Right;			//HAND_Power_Reset;
	BYTE LAMP_Yellow_Right;			//BRAKE_Driving_Release;
	BYTE LAMP_Green_Right;			//SAFETY_Clear;
	BYTE LAMP_Red_Left;				//MC_Control;
	BYTE LAMP_Yellow_Left;			//Reserved_58;
	BYTE LAMP_Green_Left;			//Reserved_59;

	BYTE HAND_Power_Reset;			//Reserved_60;
	BYTE BRAKE_Driving_Release;		//Reserved_61;
	BYTE Bumper_Clear;				//Reserved_62;
	BYTE SAFETY_Reset;				//Reserved_63;
	BYTE HOIST_Ext_Brake_Release;	//Reserved_64;
	BYTE Reserved_65;
	BYTE Reserved_66;
	BYTE OBSTACLE_Area5_Sel;		//Reserved_67;

	BYTE Hoist_Steer_PWR_Enable;	//Reserved_68;
	BYTE IO_PWR_Enable;				//Reserved_69;
	BYTE EQ_PIO_PWR_Enable;			//Reserved_70;
	BYTE Reserved_71;
	BYTE Reserved_72;
...
enum OUTPUT
{
	...
	OUT_CID_LinkRequest,    // AOHC-279
	OUT_SPARE_72,               	//AOHC-286
	OUT_SPARE_73,                 	//AOHC-286
	OUT_SPARE_74,                   	//AOHC-286
	OUT_SPARE_75, //75              	//AOHC-286
	OUT_SPARE_76,                  	//AOHC-286
	OUT_SPARE_77,                	//AOHC-286
	OUT_SPARE_78,                 	//AOHC-286
	OUT_SPARE_79,                	//AOHC-286
};
#elif(OHT_NAME == OHT_NAME_STD_V81)
enum OUTPUT
{
...
enum OUTPUT
{
	...
	OUT_SPARE_74,                      //AOHTC-286
	OUT_SPARE_75,                      //AOHTC-286
	OUT_SHUTTER_F_MIDDLE_CLOSE,

	OUT_SHUTTER_R_MIDDLE_CLOSE,
	OUT_SPARE_78,                      //AOHTC-286
	OUT_SPARE_79,                      //AOHTC-286
...
enum OUTPUT
{
	...
	OUT_HOIST_EXT_BRAKE_RELEASE,
	OUT_RESERVED_64,
	OUT_RESERVED_65,                     //AOHTC-286
	OUT_OBSTACLE_AREA5_SEL,                    //AOHTC-286
	OUT_RESERVED_67,                     //AOHTC-286
	OUT_RESERVED_68,                     //AOHTC-286
	OUT_RESERVED_69,
	...
	OUT_Blackbox_DO1,
	OUT_Blackbox_DO0,
	OUT_SHUTTER_F_MIDDLE_CLOSE,                         //AOHTC-286
	OUT_SHUTTER_R_MIDDLE_CLOSE,                         //AOHTC-286
	OUT_SPARE_78,                         //AOHTC-286
	OUT_SPARE_79,                         //AOHTC-286
...
enum OUTPUT
{
	...
	OUT_HOIST_EXT_BRAKE_RELEASE,
	OUT_QRR_POWER,
	OUT_RESERVED_62,                     //AOHTC-286
	OUT_RESERVED_63,                     //AOHTC-286
	OUT_RESERVED_64,                     //AOHTC-286
	OUT_RESERVED_65,                     //AOHTC-286
...
enum OUTPUT
{
	...
	OUT_Blackbox_DO1,
	OUT_Blackbox_DO0,
	OUT_SPARE_76,                         //AOHTC-286
	OUT_SPARE_77,                         //AOHTC-286
	OUT_SPARE_78,                         //AOHTC-286
	OUT_SPARE_79                         //AOHTC-286
};
#elif(OHT_NAME == OHT_NAME_STD_V82)
...
///mgchoi 2022-08-18. P4 Mask용 Output ENUM 정의
#elif(OHT_NAME == OHT_NAME_P4_MASK)
enum OUTPUT
{
	OUT_HAND_WORK = 0,          //0
	OUT_HAND_WORK_INTERLOCK,
	OUT_HAND_HOME,
	OUT_HAND_HOME_INTERLOCK,
	OUT_HAND_ORIGIN,
	OUT_HAND_RESET,				//5
	OUT_HAND_FREE,
	OUT_HAND_RESERVED8,
	OUT_HAND_TRIGGER_OUT,
	OUT_HAND_PIO_SEL,
	OUT_EQPIO_VALID,			//10
	OUT_EQPIO_CS_0,
	OUT_EQPIO_CS_1,
	...
	OUT_OHTDETECT_AREA2_SEL,
	OUT_OHTDETECT_AREA3_SEL,
	OUT_OHTDETECT_AREA4_SEL,   //45
	OUT_RESERVED47,
	OUT_OHTDETECT_POWER_RESET,
	OUT_LOOKDOWN_AREA1_SEL,
	OUT_LOOKDOWN_AREA2_SEL,
	OUT_LOOKDOWN_AREA3_SEL,    //50
	OUT_LOOKDOWN_AREA4_SEL,
	OUT_LOOKDOWN_POWER_RESET,
	OUT_LAMP_RED_RIGHT,
	OUT_LAMP_YELLOW_RIGHT,
	OUT_LAMP_GREEN_RIGHT,      // 55
	OUT_LAMP_RED_LEFT,
	OUT_LAMP_YELLOW_LEFT,
	OUT_LAMP_GREEN_LEFT,
	OUT_HAND_POWER_RESET,
	OUT_BRAKE_DRIVING_RELEASE, // 60
	OUT_BUMPER_CLEAR,
	OUT_SAFETY_RESET,
	OUT_HOIST_EXT_BRAKE,
	OUT_RESERVED65,
	...
	OUT_HAND_OPEN,
	OUT_RAILSUPPORT_DIR,
	OUT_RAILSUPPORT_TRQ_0,
	OUT_RAILSUPPORT_TRQ_1,
	OUT_SHUTTER_R_RESET,
	OUT_SHUTTER_R_CLOSE,        // 25
	OUT_SHUTTER_R_OPEN,
	OUT_SHUTTER_R_ORIGIN,       // 30
	OUT_SHUTTER_R_FREE,
	OUT_STB_R_WORK,
...
//mgchoi. 2022.08.24 P4 MaskOHT용 HandRMR Define
#if(OHT_NAME == OHT_NAME_P4_MASK)
#define HANDRMR_NO_COMMAND         0
#define HANDRMR_WORK_COMMAND       1
#define HANDRMR_WORK_IL_COMMAND    2    //work_interlock
#define HANDRMR_HOME_COMMAND       3
#define HANDRMR_HOME_IL_COMMAND    4     // Home_interlock
#define HANDRMR_ORIGIN_COMMAND     5
#define HANDRMR_RESET_COMMAND      6
#define HANDRMR_ORIGIN_LIMIT_TIME  7000            //msec
#define HANDRMR_MOTION_LIMIT_TIME  1500            //msec
#define HANDRMR_GRIPON_WAIT_TIME   3000            //msec
#endif
...
#if(OHT_NAME == OHT_NAME_P4_MASK)
#define SHUTTER_MOTION_LIMIT_TIME   6000            //msec
#else
...
///OHT_NAME_P4_MASK LED Define
#if(OHT_NAME==OHT_NAME_P4_MASK)
#define DEF_RED_LEFT          4
#define DEF_RED_RIGHT         5
#define DEF_GREEN_RIGHT       6
#define DEF_GREEN_LEFT        7
#endif
