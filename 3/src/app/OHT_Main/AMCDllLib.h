...
//	double	m_dNodeDetectPosition;
    ...
    int nAMCLowVibraionStatus;  //저진동 유무에 대해 받는 값 0 미사용, 1 사용  AOHC-285
...
//#elif(OHT_NAME == OHT_NAME_STD_V80_RETICLE)
	...
	STANDARD_OHT_V86_INPUT1_MASK m_Input1Mask_R01;
	STANDARD_OHT_V86_INPUT2_MASK m_Input2Mask_R01;
	STANDARD_OHT_V86_INPUT3_MASK m_Input3Mask_R01;
	...
	STANDARD_OHT_V85S_INPUT1_MASK m_Input1Mask_R01;
	STANDARD_OHT_V85S_INPUT2_MASK m_Input2Mask_R01;
	STANDARD_OHT_V85S_INPUT3_MASK m_Input3Mask_R01;
#elif(OHT_NAME == OHT_NAME_STD_V82)
	STANDARD_OHT_V90_INPUT1_MASK m_Input1Mask_R01;
	STANDARD_OHT_V90_INPUT2_MASK m_Input2Mask_R01;
	STANDARD_OHT_V90_INPUT3_MASK m_Input3Mask_R01;
	...
	P4_MASK_OHT_INPUT1_MASK m_P4MASKInput1Mask;
	P4_MASK_OHT_INPUT2_MASK m_P4MASKInput2Mask;
	P4_MASK_OHT_INPUT3_MASK m_P4MASKInput3Mask;
#endif
...
//	int GetWatchDogStatus(void);                //미사용
...
*/
	...
	void CompareNodeCheckData(AnsiString name, NODE_CHECK_DATA &data1, NODE_CHECK_DATA &data2);

public:
	// I/O 관련 함수 ----------------------------------
	int SetBit(int nIndex, bool bOnOff, bool bOBSControl, bool bUBGControal);
//	bool GetInputBit(int nIndex);             //미사용
//	bool GetOutputBit(int nIndex);            //미사용
...
//	typedef int(*AMC_GETDATAS)(void *Data);      ///< 내재화 DLL에서만 사용 가능
	...
	typedef int(*AMC_VERSION_CHK_PC)(void);

#if((OHT_NAME == OHT_NAME_STD_V82)||(OHT_NAME == OHT_NAME_STD_V86)||(OHT_NAME == OHT_NAME_P4_MASK))
	typedef int(*AMC_GET_FW_VERSION)(int nSlaveNum, int []);
#endif
...
#if((OHT_NAME == OHT_NAME_STD_V82)||(OHT_NAME == OHT_NAME_STD_V85S)||(OHT_NAME == OHT_NAME_STD_V86)||(OHT_NAME == OHT_NAME_P4_MASK))
	typedef int(*AMC_FS_AUTOPATCH)(char *pszpath, char *pszBootLoader, HWND hWnd);  //AOHC-154
#else
//	typedef int(*AMC_FS_AUTOPATCH)(char *pszpath, char *pszBootLoader, HWND hWnd);  //AOHC-154
	typedef int(*AMC_FS_AUTOPATCH)(char *pszBootLoader, HWND hWnd);  //AOHC-154
#endif
   ...
   typedef bool      (_stdcall* LOADSETTINGSERIALDEVICE)(const char *path);            //void
#endif
    ...
    AMC_VERSION_CHK_PC DeviceAMCVerChk_PC;
	//==========================================================================
...
private:
	...
	AMC_FS_AUTOPATCH DeviceAMCAutoPatch; //AOHC-154
...
#if((OHT_NAME == OHT_NAME_STD_V82)||(OHT_NAME == OHT_NAME_STD_V86)||(OHT_NAME == OHT_NAME_P4_MASK))
	AMC_GET_FW_VERSION DeviceAMCGetFWVersion; // AMOHTV80F-1703
#endif
