...
#define FT_N2STB    "SNFocus Teaching"		//  move1 -> FT Send
...
#define AT_N2STB_L      "SNLAuto Teaching"
#define AT_N2STB_R      "SNRAuto Teaching"
...
#define ZT_N    "SNZ-Axis Teaching"
#define ZT_EQ   "EZ-Axis Teaching"
#define ST		"Status"
#define RST		"Reset"   //STB    Reset
#define RST_N   "SNReset" //N2STB  Reset
#define RST_EQ  "EReset"  //EQ     Reset
#define BGE		"Begin"
#define END		"End"
...
//	DWORD GetAutoTeachingJigResponse();            //미사용
...
//	int ATDrivingMoveCheck(bool &bCheck);            //미사용

	void QRDrvingTrigger(BYTE PortType);
	bool QRDataCheck(BYTE PortType, int nTargetID);

	int Save_STBTeachingData(UINT CurStationID, BYTE PortType, double dDTeaching, double dSTeaching, double dHTeaching);
