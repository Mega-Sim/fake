...
//	WORD	GetMonitorParaValue(int index);             //미사용
...
//	bool	SetParaValue(WORD wTempAddress, int nTempSelIndex);         //미사용
//	bool	GetRcvdData(DWORD* dwTempErrcode,long* lTempReadData);      //미사용
	bool	IsCommOpen();

	bool	SetInnerLimitTorque_0();              //미사용 → AMC COmmfail시 사용
