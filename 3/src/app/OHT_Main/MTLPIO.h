...
//	bool IsMTLAutoOn();          //미사용

	// 8점 PIO 추가 내용 puting
//	bool IsAutoMode_PIO8();    //미사용
	//공통
//	bool IsMove_Back_PIO8();    //미사용
//	bool IsMove_Front_PIO8();   //미사용
//	bool IsMoveOK_PIO8();       //미사용

	//본선부 & 선회부
//	bool IsTakeOutNG_PIO8();   //빼냄 불가               // 미사용
//	bool IsTakeOutOK_PIO8();   //빼냄가능                // 미사용
//	bool IsTakeInComplete_PIO8();   //투입 완료 ??       // 미사용

	//승강부
//	bool IsTakeOutComplete_PIO8();     // 미사용
//	bool IsTakeInReq_Rail_2_PIO8();    // 미사용
//	bool IsTakeInReq_Rail_1_PIO8();    // 미사용
	//////////////////////////////////


	int OHTInpositionOnOff_TR(bool bOnOff);
	int TakeoutReqOnOff_CS1(bool bOnOff);
//	int TakeInNGOnOff(bool bOnOff);                      // 미사용
