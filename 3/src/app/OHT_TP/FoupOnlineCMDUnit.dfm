object FoupOnlineCMDForm: TFoupOnlineCMDForm
  Left = 0
  Top = 0
  Caption = 'FoupOnlineCMDForm'
  ClientHeight = 769
  ClientWidth = 804
  Color = clBtnFace
  ...
  object panBottom: TPanel
    ...
    object panSensor: TPanel
      ...
      object panEqPioInCaption: TPanel
        Left = 182
        Top = 61
        Width = 29
        Height = 17
      ...
      object panEqPIOOutCaption: TPanel
        Left = 73
        Top = 61
        Width = 29
        Height = 17
      ...
      object grpBlackBox: TGroupBox
        ...
        ParentFont = False
        TabOrder = 20
        object shpBlackBox: TShape
          Left = 3
          Top = 16
          Width = 159
          Height = 24
        end
        object lblBlackBox: TLabel
          Left = 45
          Top = 19
          Width = 78
          Height = 16
    ...
    object panFunc: TPanel
      ...
      object pgcMainControl: TPageControl
        ...
        object TabSheet3: TTabSheet
          ...
          object rgDualStageSTB: TRadioGroup
            Left = 369
            Top = 10
            Width = 96
            Height = 60
          ...
          object btnDualStage: TButton
            Left = 369
            Top = 3
            Width = 96
            Height = 22
            Caption = '2'#45800' STB Trans'
            TabOrder = 7
            OnClick = btnDualStageClick
          end
        end
        ...
        object TabSheet2: TTabSheet
          ...
          object panTrans: TPanel
            ...
            object btnLSTBQRRRead: TButton
              Left = 629
              Top = 5
              Width = 148
              Height = 28
              Caption = 'LSTB Teach Measure'
              TabOrder = 10
              OnClick = btnLSTBQRRReadClick
            end
            object btnRSTBQRRRead: TButton
              Left = 629
              Top = 37
              Width = 148
              Height = 28
              Caption = 'RSTB Teach Measure'
              TabOrder = 11
              OnClick = btnRSTBQRRReadClick
            end
          end
        end
        ...
        object tsVMS: TTabSheet
          ...
          object btnGetBTInfo: TButton
            ...
            ParentFont = False
            TabOrder = 0
            OnClick = btnGetBTInfoClick
          end
          object btnSetWait: TButton
            Left = 6
            Top = 39
            Width = 93
            Height = 25
            ...
            ParentFont = False
            TabOrder = 1
            OnClick = btnSetWaitClick
          end
          object btnSWReset: TButton
            Left = 105
            Top = 8
            Width = 93
            Height = 25
          ...
          object btnVMSConnect: TButton
            ...
            ParentFont = False
            TabOrder = 3
            OnClick = btnVMSConnectClick
          end
          object btnVMSDisconnect: TButton
            Left = 337
            Top = 8
            Width = 93
            Height = 54
  ...
  object pmUnload: TPopupMenu
    ...
    object mniUnloadSTB_L_T: TMenuItem
      Caption = '[STB_L_TOP]'
      OnClick = mniUnloadSTB_L_TClick
    end
    object mniUnloadSTB_L_B: TMenuItem
      Caption = '[STB_L_BOTTOM]'
      OnClick = mniUnloadSTB_L_BClick
    end
    object mniUnloadSTB_R_T: TMenuItem
      Caption = '[STB_R_TOP]'
      OnClick = mniUnloadSTB_R_TClick
    end
    object mniUnloadSTB_R_B: TMenuItem
      Caption = '[STB_R_BOTTOM]'
      OnClick = mniUnloadSTB_R_BClick
    end
    object N7: TMenuItem
      Caption = '-'
    end
    object mniUnloadSTB_L_B_S: TMenuItem
      Caption = '[STB_L_B_SEMES]'
      OnClick = mniUnloadSTB_L_B_SClick
    end
    object mniUnloadSTB_R_B_S: TMenuItem
      Caption = '[STB_R_B_SEMES]'
      OnClick = mniUnloadSTB_R_B_SClick
    end
    object N12: TMenuItem
      Caption = '-'
    end
    object PSTBL2: TMenuItem
      Caption = '[PSTB]'
      OnClick = PSTBL2Click
    end
  end
  object pmLoad: TPopupMenu
    ...
    object mniLoadSTB_L_T: TMenuItem
      Caption = '[STB_L_TOP]'
      OnClick = mniLoadSTB_L_TClick
    end
    object mniLoadSTB_L_B: TMenuItem
      Caption = '[STB_L_BOTTOM]'
      OnClick = mniLoadSTB_L_BClick
    end
    object mniLoadSTB_R_T: TMenuItem
      Caption = '[STB_R_TOP]'
      OnClick = mniLoadSTB_R_TClick
    end
    object mniLoadSTB_R_B: TMenuItem
      Caption = '[STB_R_BOTTOM]'
      OnClick = mniLoadSTB_R_BClick
    end
    object N6: TMenuItem
      Caption = '-'
    end
    object mniLoadSTB_L_B_S: TMenuItem
      Caption = '[STB_L_B_SEMES]'
      OnClick = mniLoadSTB_L_B_SClick
    end
    object mniLoadSTB_R_B_S: TMenuItem
      Caption = '[STB_R_B_SEMES]'
      OnClick = mniLoadSTB_R_B_SClick
    end
    object N11: TMenuItem
      Caption = '-'
    end
    object PSTBL1: TMenuItem
      Caption = '[PSTB]'
      OnClick = PSTBL1Click
    end
  end
  ...
  object pmMoveTP: TPopupMenu
    ...
    object mniMoveTPSTB_L_T: TMenuItem
      Caption = '[STB_L_TOP]'
      OnClick = mniMoveTPSTB_L_TClick
    end
    object mniMoveTPSTB_L_B: TMenuItem
      Caption = '[STB_L_BOTTOM]'
      OnClick = mniMoveTPSTB_L_BClick
    end
    object mniMoveTPSTB_R_T: TMenuItem
      Caption = '[STB_R_TOP]'
      OnClick = mniMoveTPSTB_R_TClick
    end
    object mniMoveTPSTB_R_B: TMenuItem
      Caption = '[STB_R_BOTTOM]'
      OnClick = mniMoveTPSTB_R_BClick
    end
    object N10: TMenuItem
      Caption = '-'
    end
    object mniMoveTPSTB_L_B_S: TMenuItem
      Caption = '[STB_L_B_SEMES]'
      OnClick = mniMoveTPSTB_L_B_SClick
    end
    object mniMoveTPSTB_R_B_S: TMenuItem
      Caption = '[STB_R_B_SEMES]'
      OnClick = mniMoveTPSTB_R_B_SClick
    end
  end
  ...
  object pmLoadMAC: TPopupMenu
    Left = 328
    Top = 40
    object mniLoadMAC_EQ: TMenuItem
      Caption = '[EQ]'
      OnClick = mniLoadMAC_EQClick
    end
    object mniLoadMAC_EQ_X: TMenuItem
      Caption = '[EQ_X]'
      OnClick = mniLoadMAC_EQ_XClick
    end
    object TMenuItem
      Caption = '-'
    end
    object mniLoadMAC_STOCKER: TMenuItem
      Caption = '[STOCKER]'
      OnClick = mniLoadMAC_STOCKERClick
    end
    object mniLoadMAC_LOADER: TMenuItem
      Caption = '[LOADER]'
      OnClick = mniLoadMAC_LOADERClick
    end
    object mniN15: TMenuItem
      Caption = '-'
    end
    object mniLoadMAC_STB_R: TMenuItem
      Caption = '[STB_R]'
      OnClick = mniLoadMAC_STB_RClick
    end
    object mniN16: TMenuItem
      Caption = '-'
    end
    object mniLoadMAC_UTB: TMenuItem
      Caption = '[UTB]'
      OnClick = mniLoadMAC_UTBClick
    end
    object mniN18: TMenuItem
      Caption = '-'
    end
    object mniLoadMAC_STB_R_B_SEMES: TMenuItem
      Caption = '[STB_R_B_SEMES]'
      OnClick = mniLoadMAC_STB_R_B_SEMESClick
    end
  end
  object pmUnloadMAC: TPopupMenu
    Left = 400
    Top = 40
    object mniUnloadMAC_EQ: TMenuItem
      Caption = '[EQ]'
      OnClick = mniUnloadMAC_EQClick
    end
    object mniUnloadMAC_EQ_X: TMenuItem
      Caption = '[EQ_X]'
      OnClick = mniUnloadMAC_EQ_XClick
    end
    object N14: TMenuItem
      Caption = '-'
    end
    object mniUnloadMAC_STOCKER: TMenuItem
      Caption = '[STOCKER]'
      OnClick = mniUnloadMAC_STOCKERClick
    end
    object mniUnloadMAC_LOADER: TMenuItem
      Caption = '[LOADER]'
      OnClick = mniUnloadMAC_LOADERClick
    end
    object mniN13: TMenuItem
      Caption = '-'
    end
    object mniUnloadMAC_STB_R: TMenuItem
      Caption = '[STB_R]'
      OnClick = mniUnloadMAC_STB_RClick
    end
    object mniN14: TMenuItem
      Caption = '-'
    end
    object mniUnloadMAC_UTB: TMenuItem
      Caption = '[UTB]'
      OnClick = mniUnloadMAC_UTBClick
    end
    object mniN17: TMenuItem
      Caption = '-'
    end
    object mniUnloadMAC_STB_R_B_SEMES: TMenuItem
      Caption = '[STB_R_B_SEMES]'
      OnClick = mniUnloadMAC_STB_R_B_SEMESClick
    end
  end
end
