...
void THoistParamForm::InitConfirm()
{
	...
	if((gm_OHTStatus->m_OHTInfo.OHTInfo.OHT_Type  == OHT_TYPE_EUV) && ((gm_OHTStatus->m_OHTInfo.OHTInfo.OHT_Ver == OHT_VERSION_85)||(gm_OHTStatus->m_OHTInfo.OHTInfo.OHT_Ver == OHT_VERSION_86)))
	{
