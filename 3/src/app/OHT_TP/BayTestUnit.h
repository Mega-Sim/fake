...
__published:	// IDE-managed Components
	...
	TShape *Shape_Status;
	TButton *btnVibSetting;
	TEdit *edtdelaytime;
	TCheckBox *chkdelaydrv;
	TCheckBox *chkdelayload;
	TCheckBox *chkdelayunload;
	TLabel *Label7;
	...
	void __fastcall btnVibSettingClick(TObject *Sender);
...
private:	// User declarations
	...
	//N2STB 대응용 임시
	bool	bIsN2STB[MAX_DATA];
	bool	bIsN2STB_SEC_T[MAX_DATA];
	bool	bIsN2STB_SEC_B[MAX_DATA];
	bool	bUseAutoTeachingVision[MAX_DATA];
...
public:		// User declarations
	...
	int nVibWayPointNode1;
	int nVibWayPointNode2;
	int nVibRound;
	void VibLongrunSetting();
};
//---------------------------------------------------------------------------
