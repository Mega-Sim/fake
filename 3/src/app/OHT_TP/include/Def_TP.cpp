...
String GetStringOHTVer(BYTE OHTVer)
{
	...
	case OHT_VERSION_85:
		...
		break;
	case OHT_VERSION_82:
		strRtnOHTVer = "Ver 8.2";
		break;
	case OHT_VERSION_86:
		strRtnOHTVer = "Ver 8.6";
		break;
	case OHT_VERSION_10:
		strRtnOHTVer = "Ver 1.0";
		break;
	default:
...
String GetStringOHTType(BYTE OHTType)
{
	...
	case OHT_TYPE_FOUP_S:
		...
		break;
	case OHT_TYPE_MASK:
		strRtnOHTType = "MASK";   //ssung 2022-11-02 P4 Mask용
		break;
...
String PortTypeToStr(BYTE PortType)
{
	...
	case PORT_TYPE_STB_L_B_S:
		strRtn = "STB_L_B_S";
		break;

	case PORT_TYPE_STB_R_B_S:
		strRtn = "STB_R_B_S";
		break;
