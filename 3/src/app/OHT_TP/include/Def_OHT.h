...
#define MODE_WORKER          3     //운영용(Map 기반이동 막은 ver.)

#define WARNNING_AUTO        "ERROR : 현재 Auto Mode입니다. Manual Mode로 전환 후 사용하세요."
#define WARNNING_LOADING     "ERROR : 작업(Loading) 중 입니다. 정지 후 사용하세요."
#define WARNNING_UNLOADING   "ERROR : 작업(Unloading) 중 입니다. 정지 후 사용하세요."
#define WARNNING_GOING       "ERROR : 주행 중 입니다.  정지 후 사용하세요."
#define WARNNING_MOVETPOINT  "ERROR : Teaching Point로 이동중입니다. 정지 후 사용하세요."
#define WARNNING_1RUNNING    "ERROR : #1(DRIVING)가 동작중입니다. 정지 후 사용하세요."
#define WARNNING_2RUNNING    "ERROR : #2(HOIST)가 동작중입니다. 정지 후 사용하세요."
#define WARNNING_3RUNNING    "ERROR : #3(SHIFT)가 동작중입니다. 정지 후 사용하세요."
#define WARNNING_4RUNNING    "ERROR : #4(ROTATE)가 동작중입니다. 정지 후 사용하세요."
...
#define OHT_VERSION_82      0x82 ///< v9.0
...
#define STS_AUTO_TRANS_HOMING           0x25       //AOHC-288
