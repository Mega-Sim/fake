...
private:	// User declarations
	...
	int UnicastSendAGENT(AnsiString strIpAddr, int iPort, char* buf, int len);
...
// ===================================================================
	...
	int UnicastSend_OHT_2_AGENT(char* buf, int len);
	int OHT_AGENT_ThreadCall(PKT_OHT2OCS& AS_Pkt);
#endif
