namespace LogViewer
{
    partial class UCommonTypeIn
    {
        ...
        private void InitializeComponent()
        {
			...
			// button2
			// 
			this.button2.Location = new System.Drawing.Point(342, 43);
			...
			this.Name = "UCommonTypeIn";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			this.Text = "입력하세요";
			this.Load += new System.EventHandler(this.UCommonTypeIn_Load);
