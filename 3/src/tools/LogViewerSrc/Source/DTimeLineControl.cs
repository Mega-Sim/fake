...
namespace TimeLine
{
    ...
    public class DTimeLine : UserControl
    {   
        ...
        int barStartLeft_x = 160;  // bar 를 그리기 시작하는 좌측 시작위치 x
        ...
        int itemHeightSpace = 20;      // item들 간의 세로 간격
        ...
        private void Redraw(Graphics gfx)
        {
            if (gfx == null)
                return;
