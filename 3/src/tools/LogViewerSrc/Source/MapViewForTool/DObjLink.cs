...
namespace ObjectDrawig
{
    public class DObjLink : DObjBase
    {
        ...
        public static Pen Pen_SpdUnset = new Pen(Color.FromArgb(0xDF, 0xDF, 0xDF, 2));          // unset speed          // unset speed
        public static Pen Pen_SpdOver0 = new Pen(Color.FromArgb(0xDF, 0xDF, 0xDF), 2);          // 0<= speed <1300          // 0<= speed <1300
        public static Pen Pen_Green = new Pen(Color.LimeGreen, 2);     //초록
        public static Pen Pen_Orange = new Pen(Color.FromArgb(0xFF, 0xCF, 0x00), 2);      // 주황
        public static Pen Pen_Red = new Pen(Color.FromArgb(0xDF, 0x00, 0x14), 2);      // 빨강
            ...
            else
            {
                ...
                else
                {
                    if(!bVibration)
                    {
                        ...
                        else if (SelectedColorType == 2)
                        {
                            thePen = Pen_Orange;
                        }
                        else if (SelectedColorType == 3)
                        {
                            thePen = Pen_Red;
                        }
                    }
                    ...
                    {
                        if (VibrationValue >= 0.8)
                            thePen = Pen_Red;
                        else if (VibrationValue >= 0.6)
                            thePen = Pen_Orange;
                        else if (VibrationValue < 0.6 && VibrationValue >= 0)
                            thePen = Pen_Green;
                        else
                            thePen = Pen_SpdOver0;
                    }
