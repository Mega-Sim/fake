...
namespace ObjectDrawig
{
    ...
    public abstract class DObjBase
    {
        ...
        public static bool bDrawNodeDetail = true;
        ...
        public static Pen flagPen = new Pen(Color.FromArgb(0x2D, 0x2D, 0x2D), 2);
        ...
        public void DrawFlag(Graphics g, DScale scale)
        {
            if (bDrawFlag)
            {
                ...
                g.DrawString(strFlagMemo, flagFont, Brushes.White, pos_dc.X + 12, pos_dc.Y - 24);
