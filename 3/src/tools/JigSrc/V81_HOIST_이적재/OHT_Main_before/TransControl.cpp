...
//		pParamSet->TransDefine.nDnState_UP_SpeedDown_Percent_SpecialEQ = 100;
	...
	pParamSet->TransDefine.nHoistMoveDown_TeachingOffset_Load = 70;  ///< Hoist Down ?à??¸ :?ӱ??? Offset

	pParamSet->TransDefine.nHoistMoveUp_HomeOffset_Unload = 50;  ///< Hoist Up ?à??¸ Offset
	pParamSet->TransDefine.nHoistMoveUp_TeachingOffset_Unload = 25;  ///< Hoist Up ?à?À۠:?ӱ??? Offset
	pParamSet->TransDefine.nHoistMoveDown_TeachingOffset_Unload = 50;  ///< Hoist Down ?à??¸ :?ӱ??? Offset
