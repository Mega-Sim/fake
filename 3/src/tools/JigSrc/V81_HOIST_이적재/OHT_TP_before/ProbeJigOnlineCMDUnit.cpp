...
#pragma resource "*.dfm"
TProbeJigOnlineCMDForm *ProbeJigOnlineCMDForm;
TCHKOHT CmdProbeJigOHTCheck;

// by zzang9un 2013.04.24 : Timer Interval Setting
#define TIMER_INTV_TRANSLONGRUN     50  ///< 이적재 롱런 타이머 Interval

// ---------------------------------------------------------------------------
__fastcall TProbeJigOnlineCMDForm::TProbeJigOnlineCMDForm(TComponent *Owner) : TForm(Owner)
{
...
// ---------------------------------------------------------------------------
void __fastcall TProbeJigOnlineCMDForm::WMEXITSIZEMOVE(TMessage &msg)
{
    int nTmpLeft, nTmpTop, nTmpRight;

    nTmpLeft  = ProbeJigOnlineCMDForm->Left;
    nTmpTop   = ProbeJigOnlineCMDForm->Top;
    nTmpRight = nTmpLeft + ProbeJigOnlineCMDForm->Width;
...
// ---------------------------------------------------------------------------
TTextAttributes *__fastcall TProbeJigOnlineCMDForm::CurrText(void)
{
...
// ---------------------------------------------------------------------------
/**
 @brief   ProbeJigOnlineCMDForm의 Show 발생시 호출되는 이벤트 함수
 @author  puting
 @date    2012.12.14
 */
void __fastcall TProbeJigOnlineCMDForm::FormShow(TObject *Sender)
{
...
// ---------------------------------------------------------------------------
void __fastcall TProbeJigOnlineCMDForm::FormClose(TObject *Sender,
    TCloseAction &Action)
{
    timerAllDisable();
}
...
// ---------------------------------------------------------------------------
int TProbeJigOnlineCMDForm::Check_Invalid_Command(String strTmpCMD)
{
    ...
    if((strTmpCMD.Pos("[") != 0) || (strTmpCMD.Pos("]") != 0))
    {
        ...
        {
			if(CmdProbeJigOHTCheck.Is_Executable
...
void __fastcall TProbeJigOnlineCMDForm::mniMemoClearClick(TObject *Sender)
{
    PMACMemo->Clear();
}

// ---------------------------------------------------------------------------
void TProbeJigOnlineCMDForm::PMACDataDisplay(TColor TmpFontColor, String strDisplayData)
{
...
/**
 ...
 @date    2012.12.14
 */
void __fastcall TProbeJigOnlineCMDForm::btnHandCloseClick(TObject *Sender)
{
    if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
    {
...
/**
 ...
 @date    2012.12.14
 */
void __fastcall TProbeJigOnlineCMDForm::btnHandOpenClick(TObject *Sender)
{
    if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
    {
 ...
 */
void __fastcall TProbeJigOnlineCMDForm::btnGoClick(TObject *Sender)
{
    if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
    {
...
/**
 ...
 @param   EStop
 */
void __fastcall TProbeJigOnlineCMDForm::btnStopClick(TObject *Sender)
{
    TCMDCONTROL *m_CMDControl = new TCMDCONTROL;
...
/**
 ...
 @date    2012.12.14
 */
void __fastcall TProbeJigOnlineCMDForm::btnTransMarkForwardClick(TObject *Sender)
{
    if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
    {
        String strTmpCMD;
...
/**
 ...
 @date    2012.12.14
 */
void __fastcall TProbeJigOnlineCMDForm::btnTransMarkBackwardClick(TObject *Sender)
{
    if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
    {
        String strTmpCMD;
...
void __fastcall TProbeJigOnlineCMDForm::memoJogKeyControlExit(TObject *Sender)
{
...
void __fastcall TProbeJigOnlineCMDForm::memoJogKeyControlClick(TObject *Sender)
{
...
@date    2013.02.19
*/
void __fastcall TProbeJigOnlineCMDForm::memoJogKeyControlKeyDown(TObject *Sender,
...
@date    2013.02.19
*/
void __fastcall TProbeJigOnlineCMDForm::memoJogKeyControlKeyUp(TObject *Sender,
    WORD &Key, TShiftState Shift)
{    TCMDCONTROL *m_CMDControl = new TCMDCONTROL;
...
*/
void __fastcall TProbeJigOnlineCMDForm::timerDrivingJogTimer(TObject *Sender)
{
    bool bError = NO_ERR;
    ...
    if(memoJogKeyControl->Focused())
    {
        ...
        if(CmdProbeJigOHTCheck.Is_Executable(EXCLUDE_DRIVING_RUNNING) == NO_ERR)
        {
...
/**
 ...
 @date    2012.12.14
 */
void __fastcall TProbeJigOnlineCMDForm::btnHandOriginClick(TObject *Sender)
{
    if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
    {
        TCMDCONTROL *m_CMDControl = new TCMDCONTROL;
...
/**
 ...
 @date    2012.12.14
 */
void __fastcall TProbeJigOnlineCMDForm::btnHandResetClick(TObject *Sender)
{
    if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
    {
        TCMDCONTROL *m_CMDControl = new TCMDCONTROL;
...
/**
 ...
 @date    2012.12.14
 */
void __fastcall TProbeJigOnlineCMDForm::btnHandFreeClick(TObject *Sender)
{
    if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
    {
        TCMDCONTROL *m_CMDControl = new TCMDCONTROL;
...
void __fastcall TProbeJigOnlineCMDForm::btnSteeringLeftClick(TObject *Sender)
{
    if(CmdProbeJigOHTCheck.Is_Executable(EXCLUDE_DRIVING_RUNNING) == NO_ERR)
    {
        TCMDCONTROL *m_CMDControl = new TCMDCONTROL;
...
// ---------------------------------------------------------------------------
void __fastcall TProbeJigOnlineCMDForm::btnSteeringRightClick(TObject *Sender)
{
    if(CmdProbeJigOHTCheck.Is_Executable(EXCLUDE_DRIVING_RUNNING) == NO_ERR)
    {
        TCMDCONTROL *m_CMDControl = new TCMDCONTROL;
...
@date    2012.12.14
*/
void __fastcall TProbeJigOnlineCMDForm::btnShutterOpenClick(TObject *Sender)
{
	...
	bool CardFDetect = gm_OHTStatus->IOInput->uInput.InputProbe.CARD_Detect_F;
	bool CardRDetect = gm_OHTStatus->IOInput->uInput.InputProbe.CARD_Detect_R;
	*/
    ...
    if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
	{
		if(gm_OHTStatus->IOInput->uInput.InputProbe.HAND_Open == ON)
        {
...
@date    2012.12.14
*/
void __fastcall TProbeJigOnlineCMDForm::btnShutterCloseClick(TObject *Sender)
{
    if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
    {
        TCMDCONTROL *m_CMDControl = new TCMDCONTROL;
...
@date    2012.12.14
*/
void __fastcall TProbeJigOnlineCMDForm::btnShutterOriginClick(TObject *Sender)
{
	...
	// 류건진 책임 고칠 것.
	/*
	bool FoupDetect = gm_OHTStatus->IOInput->uInput.InputProbe.FOUP_Detect;
...
@date    2012.12.14
*/
void __fastcall TProbeJigOnlineCMDForm::btnShutterFreeClick(TObject *Sender)
{
    if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
    {
        TCMDCONTROL *m_CMDControl = new TCMDCONTROL;
...
// ---------------------------------------------------------------------------
int TProbeJigOnlineCMDForm::Set_UBGColor(int nOutput)
{
    int nError = 0;
...
/**
 @brief   ProbeJigOnlineCMDForm UI를 주기적으로 갱신하는 Timer 이벤트 함수
 @author  zzang9un
 @date    2013.03.29
 */
void __fastcall TProbeJigOnlineCMDForm::timerUpdateDisplayTimer(TObject *Sender)
{
    String strVelData;
	...
	panFoupDetect->Color = (gm_OHTStatus->IOInput->uInput.InputProbe.FOUP_Detect == ON) ? COLOR_LIME : COLOR_WHITE;
	*/
...
@date    2012.12.14
*/
void __fastcall TProbeJigOnlineCMDForm::btnStopTagBCRClick(TObject *Sender)
{
    if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
    {
        TCMDCONTROL *m_CMDControl = new TCMDCONTROL;
...
@date    2012.12.14
*/
void __fastcall TProbeJigOnlineCMDForm::btnMotor2HomeClick(TObject *Sender)
{
    CmdProbeJigOHTCheck.Axis_Hoist_HOME();
}
// ---------------------------------------------------------------------------
...
i226 = (M262/3072) * 16
*/
void __fastcall TProbeJigOnlineCMDForm::mniHoistOriginSetClick(TObject *Sender)
{
    if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
    {
        TCMDCONTROL *m_CMDControl = new TCMDCONTROL;
...
void __fastcall TProbeJigOnlineCMDForm::mniShiftOriginSetClick(TObject *Sender)
{
    if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
    {
        TCMDCONTROL *m_CMDControl = new TCMDCONTROL;
...
@date    2012.12.14
*/
void __fastcall TProbeJigOnlineCMDForm::edtSpeedChange(TObject *Sender)
{
...
/**
 ...
 @date    2012.12.14
 */
void __fastcall TProbeJigOnlineCMDForm::btnMoveStopClick(TObject *Sender)
{
    if(CmdProbeJigOHTCheck.Is_Executable(EXCLUDE_HOIST_RUNNING EXCLUDE_SHIFT_RUNNING EXCLUDE_ROTATE_RUNNING) == NO_ERR)
    {
        TCMDCONTROL *m_CMDControl = new TCMDCONTROL;
...
void __fastcall TProbeJigOnlineCMDForm::FormCreate(TObject *Sender)
{
    int j                         = 0;
    ProbeJigOnlineCMDForm->Top            = MainForm->Top;
    ProbeJigOnlineCMDForm->Left           = MainForm->Left + MainForm->Width + StatusForm->Width;
...
// ---------------------------------------------------------------------------
void __fastcall TProbeJigOnlineCMDForm::pgcMainControlDrawTab(
...
// ---------------------------------------------------------------------------
void TProbeJigOnlineCMDForm::Warnning_Display(TColor tWColor, String strData)
{
...
void __fastcall TProbeJigOnlineCMDForm::PWGridDrawCell(TObject *Sender, int ACol,
...
/**
 ...
 @date    2012.12.14
 */
void __fastcall TProbeJigOnlineCMDForm::btnHaONClick(TObject *Sender)
{
    if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
    {
...
/**
 ...
 @date    2012.12.14
 */
void __fastcall TProbeJigOnlineCMDForm::btnHaOFFClick(TObject *Sender)
{
    if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
    {
        String strTmpMessage;
...
/**
 ...
 @date    2012.12.14
 */
void __fastcall TProbeJigOnlineCMDForm::btnHaRstClick(TObject *Sender)
{
    if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
    {
        String strTmpMessage;
...
/**
 ...
 @param   Sender : TObject
 */
void __fastcall TProbeJigOnlineCMDForm::timerTransLongRunTimer(TObject *Sender)
{
...
void __fastcall TProbeJigOnlineCMDForm::chkLongRunClick(TObject *Sender)
{
...
/**
 ...
 @date    2012.12.14
 */
void __fastcall TProbeJigOnlineCMDForm::btnShutterAlarmResetClick(TObject *Sender)
{
    if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
    {
        TCMDCONTROL *m_CMDControl = new TCMDCONTROL;
...
/**
 ...
 @param   EStop
 */
void __fastcall TProbeJigOnlineCMDForm::btnMotor34HomeClick(TObject *Sender)
{
    TCMDCONTROL *m_CMDControl = new TCMDCONTROL;
...
/**
 ...
 @date    2012.12.14
 */
void __fastcall TProbeJigOnlineCMDForm::btnLoadMouseDown(TObject *Sender,
...
/**
 ...
 @date    2012.12.14
 */
void __fastcall TProbeJigOnlineCMDForm::btnUnloadMouseDown(TObject *Sender,
    TMouseButton Button, TShiftState Shift, int X, int Y)
{
    TPoint P, Q;
    if(Button == mbLeft)
...
void __fastcall TProbeJigOnlineCMDForm::pmDrivingFServoOnOffPopup(TObject *Sender)
{
...
void __fastcall TProbeJigOnlineCMDForm::pmDrivingRServoOnOffPopup(TObject *Sender)
{
...
void __fastcall TProbeJigOnlineCMDForm::pmHoistServoOnOffPopup(TObject *Sender)
{
...
void __fastcall TProbeJigOnlineCMDForm::pmShiftServoOnOffPopup(TObject *Sender)
{
...
void __fastcall TProbeJigOnlineCMDForm::pmRotatePopup(TObject *Sender)
{
...
void __fastcall TProbeJigOnlineCMDForm::mniDrvFServoOnClick(TObject *Sender)
{
    if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
    {
        TCMDCONTROL *m_CMDControl = new TCMDCONTROL;
...
void __fastcall TProbeJigOnlineCMDForm::mniDrvFServoOffClick(TObject *Sender)
{
    if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
    {
        TCMDCONTROL *m_CMDControl = new TCMDCONTROL;
...
void __fastcall TProbeJigOnlineCMDForm::mniDrivingRServoOnClick(TObject *Sender)
{
    if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
    {
        TCMDCONTROL *m_CMDControl = new TCMDCONTROL;
...
void __fastcall TProbeJigOnlineCMDForm::mniDrivingRServoOffClick(TObject *Sender)
{
    if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
    {
        TCMDCONTROL *m_CMDControl = new TCMDCONTROL;
...
void __fastcall TProbeJigOnlineCMDForm::mniHoistServoOnClick(TObject *Sender)
{
    if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
    {
        TCMDCONTROL *m_CMDControl = new TCMDCONTROL;
...
void __fastcall TProbeJigOnlineCMDForm::mniHoistServoOffClick(TObject *Sender)
{
    if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
    {
        TCMDCONTROL *m_CMDControl = new TCMDCONTROL;
...
void __fastcall TProbeJigOnlineCMDForm::mniShiftServoOnClick(TObject *Sender)
{
    if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
    {
        TCMDCONTROL *m_CMDControl = new TCMDCONTROL;
...
void __fastcall TProbeJigOnlineCMDForm::mniShiftServoOffClick(TObject *Sender)
{
    if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
    {
        TCMDCONTROL *m_CMDControl = new TCMDCONTROL;
...
void __fastcall TProbeJigOnlineCMDForm::mniRotateServoOnClick(TObject *Sender)
{
    if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
    {
        TCMDCONTROL *m_CMDControl = new TCMDCONTROL;
...
void __fastcall TProbeJigOnlineCMDForm::mniRotateServoOffClick(TObject *Sender)
{
    if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
    {
        TCMDCONTROL *m_CMDControl = new TCMDCONTROL;
...
void __fastcall TProbeJigOnlineCMDForm::mniRotateOriginSetClick(TObject *Sender)
{
...
/**
 ...
 @date    2012.12.14
 */
void __fastcall TProbeJigOnlineCMDForm::btnRotate_OrignClick(TObject *Sender)
{
    bool bExec = false;

    // if((CmdProbeJigOHTCheck.Is_Executable()==NO_ERR)&&(CmdProbeJigOHTCheck.Is_MoveAxis_Rotate()==NO_ERR))
    if((gm_OHTStatus->IOInput->uInput.InputProbe.HOIST_Home == ON) &&
        (fabs(StrToFloat(gm_OHTStatus->Motor_Hoist->dPosition_mm)) < HOIST_ORIGIN_LIMIT))
    {
        if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
...
/**
 ...
 @date    2012.12.14
 */
void __fastcall TProbeJigOnlineCMDForm::btnRotate_EnableClick(TObject *Sender)
{
    if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
    {
        TCMDCONTROL *m_CMDControl = new TCMDCONTROL;
...
/**
 ...
 @date    2012.12.14
 */
void __fastcall TProbeJigOnlineCMDForm::btnRotate_DisableClick(TObject *Sender)
{
    if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
    {
        TCMDCONTROL *m_CMDControl = new TCMDCONTROL;
...
/**
 ...
 @date    2012.12.14
 */
void __fastcall TProbeJigOnlineCMDForm::btnRotate_StopClick(TObject *Sender)
{
    TCMDCONTROL *m_CMDControl = new TCMDCONTROL;
...
/**
 ...
 @date    2012.12.14
 */
void __fastcall TProbeJigOnlineCMDForm::btnFSteerONClick(TObject *Sender)
{
    TCMDCONTROL *m_CMDControl = new TCMDCONTROL;
...
/**
 ...
 @date    2012.12.14
 */
void __fastcall TProbeJigOnlineCMDForm::btnFSteerOFFClick(TObject *Sender)
{
    TCMDCONTROL *m_CMDControl = new TCMDCONTROL;
...
/**
 ...
 @date    2012.12.14
 */
void __fastcall TProbeJigOnlineCMDForm::btnRSteerONClick(TObject *Sender)
{
    TCMDCONTROL *m_CMDControl = new TCMDCONTROL;
...
/**
 ...
 @date    2012.12.14
 */
void __fastcall TProbeJigOnlineCMDForm::btnRSteerOFFClick(TObject *Sender)
{
    TCMDCONTROL *m_CMDControl = new TCMDCONTROL;
...
void __fastcall TProbeJigOnlineCMDForm::chkDistClick(TObject *Sender)
{
...
// ---------------------------------------------------------------------------
int TProbeJigOnlineCMDForm::DistChang_mm_2(void)
{
    int nError = 0;
...
// ---------------------------------------------------------------------------
int TProbeJigOnlineCMDForm::DistChang_cts_2(void)
{
    int nError = 0;
    float dDist_mm, dDist_M, dDist_cts;
    String strdd;
...
// ---------------------------------------------------------------------------
void __fastcall TProbeJigOnlineCMDForm::edtDistmmChange(TObject *Sender)
{
    DistChang_mm_2();
}
// ---------------------------------------------------------------------------

void __fastcall TProbeJigOnlineCMDForm::edtDistctsChange(TObject *Sender)
{
    DistChang_cts_2();
}
// ---------------------------------------------------------------------------

void __fastcall TProbeJigOnlineCMDForm::btnMoveClick(TObject *Sender)
{
...
/**
 ...
 @date    2012.12.14
 */
void __fastcall TProbeJigOnlineCMDForm::btnScanUTBClick(TObject *Sender)
{
    String strTmpMessage;
    ...
    if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
    {
        ...
        else
        {
            ...
            if(Application->MessageBox(strTmpMessage.w_str(), L"Confirm", MB_OKCANCEL) == IDOK)
            {
                ...
                if(ProbeJigOnlineCMDForm->chkLongRun->Checked == true)
...
/**
 ...
 @date    2012.12.14
 */
void __fastcall TProbeJigOnlineCMDForm::chkUpDnClick(TObject *Sender)
{
...
void __fastcall TProbeJigOnlineCMDForm::btnTractionLeftClick(TObject *Sender)
{
    if(CmdProbeJigOHTCheck.Is_Executable(EXCLUDE_DRIVING_RUNNING) == NO_ERR)
    {
        TCMDCONTROL *m_CMDControl = new TCMDCONTROL;
...
void __fastcall TProbeJigOnlineCMDForm::btnTractionRightClick(TObject *Sender)
{
    if(CmdProbeJigOHTCheck.Is_Executable(EXCLUDE_DRIVING_RUNNING) == NO_ERR)
    {
        TCMDCONTROL *m_CMDControl = new TCMDCONTROL;
...
void __fastcall TProbeJigOnlineCMDForm::chkTractionModeClick(TObject *Sender)
{
...
/**
 ...
 @date    2012.12.14
 */
void __fastcall TProbeJigOnlineCMDForm::btnRotateOriginClick(TObject *Sender)
{
    if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
    {
        TCMDCONTROL *m_CMDControl = new TCMDCONTROL;
...
/**
 ...
 @date    2012.12.14
 */
void __fastcall TProbeJigOnlineCMDForm::btnRotateResetClick(TObject *Sender)
{
    if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
    {
        TCMDCONTROL *m_CMDControl = new TCMDCONTROL;
...
/**
 ...
 @date    2012.12.14
 */
void __fastcall TProbeJigOnlineCMDForm::btnRotate0Click(TObject *Sender)
{
    if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
    {
        TCMDCONTROL *m_CMDControl = new TCMDCONTROL;
...
/**
 ...
 @date    2012.12.14
 */
void __fastcall TProbeJigOnlineCMDForm::btnRotate90Click(TObject *Sender)
{
    if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
    {
        TCMDCONTROL *m_CMDControl = new TCMDCONTROL;
...
/**
 ...
 @date    2012.12.14
 */
void __fastcall TProbeJigOnlineCMDForm::btnRotate180Click(TObject *Sender)
{
    if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
    {
        TCMDCONTROL *m_CMDControl = new TCMDCONTROL;
...
/**
 ...
 @date    2012.12.14
 */
void __fastcall TProbeJigOnlineCMDForm::btnRotate270Click(TObject *Sender)
{
    if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
    {
        TCMDCONTROL *m_CMDControl = new TCMDCONTROL;
...
/**
 ...
 @date    2012.12.14
 */
void __fastcall TProbeJigOnlineCMDForm::btnRotateFreeClick(TObject *Sender)
{
    if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
    {
        TCMDCONTROL *m_CMDControl = new TCMDCONTROL;
...
/**
 ...
 @date    2012.12.14
 */
void __fastcall TProbeJigOnlineCMDForm::btnMCControlOnClick(TObject *Sender)
{
...
/**
 ...
 @date    2012.12.14
 */
void __fastcall TProbeJigOnlineCMDForm::btnMCControlOffClick(TObject *Sender)
{
    ///추가 puting 2012.11.28
    TCMDCONTROL *m_CMDControl = new TCMDCONTROL;
...
/**
 ...
 @date    2012.12.14
 */
void __fastcall TProbeJigOnlineCMDForm::btnSTB_R_WrokOnClick(TObject *Sender)
{
    ///추가 puting 2012.11.28
    TCMDCONTROL *m_CMDControl = new TCMDCONTROL;
...
/**
 ...
 @date    2012.12.14
 */
void __fastcall TProbeJigOnlineCMDForm::btnSTB_R_WorkOffClick(TObject *Sender)
{
    ///추가 puting 2012.11.28
    TCMDCONTROL *m_CMDControl = new TCMDCONTROL;
...
/**
 ...
 @date    2012.12.14
 */
void __fastcall TProbeJigOnlineCMDForm::btnSTB_L_WrokOnClick(TObject *Sender)
{
    ///추가 puting 2012.11.28
    TCMDCONTROL *m_CMDControl = new TCMDCONTROL;
...
/**
 ...
 @date    2012.12.14
 */
void __fastcall TProbeJigOnlineCMDForm::btnSTB_L_WrokOffClick(TObject *Sender)
{
    ///추가 puting 2012.11.28
    TCMDCONTROL *m_CMDControl = new TCMDCONTROL;
...
/**
 ...
 @date    2012.12.14
 */
void __fastcall TProbeJigOnlineCMDForm::btnRailWorkClick(TObject *Sender)
{
    ///추가 puting 2012.11.28
    TCMDCONTROL *m_CMDControl = new TCMDCONTROL;
...
/**
 ...
 @date    2012.12.14
 */
void __fastcall TProbeJigOnlineCMDForm::btnRailHomeClick(TObject *Sender)
{
    ///추가 puting 2012.11.28
    TCMDCONTROL *m_CMDControl = new TCMDCONTROL;
...
/**
 ...
 @date    2012.12.14
 */
void __fastcall TProbeJigOnlineCMDForm::btnRailFreeClick(TObject *Sender)
{
    ///추가 puting 2012.11.28
    TCMDCONTROL *m_CMDControl = new TCMDCONTROL;
...
/**
 ...
 @date    2012.12.14
 */
void __fastcall TProbeJigOnlineCMDForm::btnRailEnableClick(TObject *Sender)
{
    ///추가 puting 2012.11.28
    TCMDCONTROL *m_CMDControl = new TCMDCONTROL;
...
/**
 ...
 @date    2012.12.14
 */
void __fastcall TProbeJigOnlineCMDForm::btnDrivingBCRClick(TObject *Sender)
{
    if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
    {
        TCMDCONTROL *m_CMDControl = new TCMDCONTROL;
...
/**
 ...
 @date    2012.12.14
 */
void __fastcall TProbeJigOnlineCMDForm::btnDrivingMarkBackwardClick(
    TObject *Sender)
{
    if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
    {
...
/**
 ...
 @date    2012.12.14
 */
void __fastcall TProbeJigOnlineCMDForm::btnDrivingMarkForwardClick(TObject *Sender)
{
    if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
    {
        String strTmpCMD;
...
@return  변환된 값
*/
BYTE TProbeJigOnlineCMDForm::GetTransNodeType(int index)
{
    BYTE rtnVal = 0x00;
...
@param   Sender : TObject
*/
void __fastcall TProbeJigOnlineCMDForm::chkGoStationClick(TObject *Sender)
{
    if(chkGoStation->Checked)
    {
...
void __fastcall TProbeJigOnlineCMDForm::mniLoadEQClick(TObject *Sender)
{
...
void __fastcall TProbeJigOnlineCMDForm::mniLoadEQ_XClick(TObject *Sender)
{
    // by zzang9un 2012.12.02 : 새로 변경한 TransForm을 이용하도록 수정
    if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
    {
...
void __fastcall TProbeJigOnlineCMDForm::mniLoadSTOCKERClick(TObject *Sender)
{
    // by zzang9un 2012.12.02 : 새로 변경한 TransForm을 이용하도록 수정
    if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
    {
...
void __fastcall TProbeJigOnlineCMDForm::mniLoadSTB_LClick(TObject *Sender)
{
    // by zzang9un 2012.12.02 : 새로 변경한 TransForm을 이용하도록 수정
    if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
    {
...
void __fastcall TProbeJigOnlineCMDForm::mniLoadSTB_RClick(TObject *Sender)
{
    // by zzang9un 2012.12.02 : 새로 변경한 TransForm을 이용하도록 수정
    if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
    {
...
void __fastcall TProbeJigOnlineCMDForm::mniLoadUTBClick(TObject *Sender)
{
    // by zzang9un 2012.12.02 : 새로 변경한 TransForm을 이용하도록 수정
    if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
    {
...
void __fastcall TProbeJigOnlineCMDForm::mniLoadLOADERClick(TObject *Sender)
{
    // by zzang9un 2012.12.02 : 새로 변경한 TransForm을 이용하도록 수정
    if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
    {
...
void __fastcall TProbeJigOnlineCMDForm::mniUnloadEQClick(TObject *Sender)
{
    // by zzang9un 2012.12.02 : 새로 변경한 TransForm을 이용하도록 수정
    if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
    {
...
void __fastcall TProbeJigOnlineCMDForm::mniUnloadEQ_XClick(TObject *Sender)
{
    // by zzang9un 2012.12.02 : 새로 변경한 TransForm을 이용하도록 수정
    if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
    {
...
void __fastcall TProbeJigOnlineCMDForm::mniUnloadSTOCKERClick(TObject *Sender)
{
    // by zzang9un 2012.12.02 : 새로 변경한 TransForm을 이용하도록 수정
    if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
    {
...
void __fastcall TProbeJigOnlineCMDForm::mniUnloadLOADERClick(TObject *Sender)
{
    // by zzang9un 2012.12.02 : 새로 변경한 TransForm을 이용하도록 수정
    if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
    {
...
void __fastcall TProbeJigOnlineCMDForm::mniUnloadSTB_LClick(TObject *Sender)
{
    // by zzang9un 2012.12.02 : 새로 변경한 TransForm을 이용하도록 수정
    if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
    {
...
void __fastcall TProbeJigOnlineCMDForm::mniUnloadSTB_RClick(TObject *Sender)
{
    // by zzang9un 2012.12.02 : 새로 변경한 TransForm을 이용하도록 수정
    if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
    {
...
void __fastcall TProbeJigOnlineCMDForm::mniUnloadUTBClick(TObject *Sender)
{
    // by zzang9un 2012.12.02 : 새로 변경한 TransForm을 이용하도록 수정
    if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
    {
...
/**
 ...
 @date    2013.03.26
 */
void __fastcall TProbeJigOnlineCMDForm::btnQRTagLeftMarkClick(TObject *Sender)
{
    if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
    {
        if((gm_OHTStatus->Motor_Driving_F->nError == 1) ||
...
/**
 ...
 @date    2013.03.26
 */
void __fastcall TProbeJigOnlineCMDForm::btnQRTagRightMarkClick(TObject *Sender)
{
    if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
    {
        if((gm_OHTStatus->Motor_Driving_F->nError == 1) ||
...
// ---------------------------------------------------------------------------
void __fastcall TProbeJigOnlineCMDForm::panTeachingSaveClick(TObject *Sender)
{
    TeachingForm->Show();
...
/**
@brief   ProbeJigOnlineCMDForm의 Timer를 Enable하는 함수
@author  zzang9un
@date    2013.11.20
*/
void TProbeJigOnlineCMDForm::timerAllDisable()
{
    timerUpdateDisplay->Enabled = false;
    timerDrivingJog->Enabled = false;
    timerTransLongRun->Enabled = false;
...
void __fastcall TProbeJigOnlineCMDForm::btnMoveTeachingPointMouseDown(TObject *Sender, TMouseButton Button,
...
void __fastcall TProbeJigOnlineCMDForm::mniMoveTPEQClick(TObject *Sender)
{
    if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
    {
        // TransForm을 Show하기 전 기본 이적재 정보를 Setting한다.
...
void __fastcall TProbeJigOnlineCMDForm::mniMoveTPEQ_XClick(TObject *Sender)
{
    if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
    {
        // TransForm을 Show하기 전 기본 이적재 정보를 Setting한다.
...
void __fastcall TProbeJigOnlineCMDForm::mniMoveTPSTOCKERClick(TObject *Sender)
{
    if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
    {
        // TransForm을 Show하기 전 기본 이적재 정보를 Setting한다.
...
void __fastcall TProbeJigOnlineCMDForm::mniMoveTPLOADERClick(TObject *Sender)
{
    if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
    {
        // TransForm을 Show하기 전 기본 이적재 정보를 Setting한다.
...
void __fastcall TProbeJigOnlineCMDForm::mniMoveTPSTB_LClick(TObject *Sender)
{
	if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
    {
        // TransForm을 Show하기 전 기본 이적재 정보를 Setting한다.
...
void __fastcall TProbeJigOnlineCMDForm::mniMoveTPSTB_RClick(TObject *Sender)
{
    if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
    {
        // TransForm을 Show하기 전 기본 이적재 정보를 Setting한다.
...
void __fastcall TProbeJigOnlineCMDForm::mniMoveTPUTBClick(TObject *Sender)
{
	if(CmdProbeJigOHTCheck.Is_Executable() == NO_ERR)
    {
        // TransForm을 Show하기 전 기본 이적재 정보를 Setting한다.
