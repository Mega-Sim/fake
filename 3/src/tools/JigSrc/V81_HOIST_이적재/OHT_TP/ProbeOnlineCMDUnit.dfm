object ProbeOnlineCMDForm: TProbeOnlineCMDForm
  Left = 0
  Top = 0
  Caption = 'ProbeOnlineCMDForm'
  ClientHeight = 742
  ClientWidth = 516
  Color = clBtnFace
