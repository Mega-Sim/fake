...
//		gm_OHTStatus->IOInput->uInputCommon.SPARE_18                                  = gm_OHTStatus->IOInput->uInput.Input_V81.SPARE_18;
	 ...
	 else if(gm_OHTStatus->m_OHTInfo.OHTInfo.OHT_Ver == OHT_VERSION_85)
	 {
		...
		gm_OHTStatus->IOInput->uInputCommon.HOIST_Home		                          = gm_OHTStatus->IOInput->uInput.Input_EUV.HOIST_Home;		// 미사용
		gm_OHTStatus->IOInput->uInputCommon.HNAD_ES                                   = gm_OHTStatus->IOInput->uInput.Input_EUV.HNAD_ES;               // 미사용
		...
		gm_OHTStatus->IOInput->uInputCommon.EQPIO_Left_Go   		                  = gm_OHTStatus->IOInput->uInput.Input_EUV.EQPIO_Left_Go;   		//	BYTE EQPIO_Right_Go;미사용
		...
		gm_OHTStatus->IOInput->uInputCommon.OBSTACLE_Input_Extend    	              = gm_OHTStatus->IOInput->uInput.Input_EUV.OBSTACLE_Input_Extend;     	// 미사용
		...
		gm_OHTStatus->IOInput->uInputCommon.OHTDETECT_Input_Extend                    = gm_OHTStatus->IOInput->uInput.Input_EUV.OHTDETECT_Input_Extend;   	// 미사용
		...
		gm_OHTStatus->IOInput->uInputCommon.UTB_Detect                                = gm_OHTStatus->IOInput->uInput.Input_EUV.UTB_Detect;				// 미사용
		...
		gm_OHTStatus->IOInput->uInputCommon.TP_Enable                                 = gm_OHTStatus->IOInput->uInput.Input_EUV.TP_Enable;				// 미사용;
		...
		gm_OHTStatus->IOInput->uInputCommon.Rotate_270_Sensor                         = gm_OHTStatus->IOInput->uInput.Input_EUV.Rotate_270_Sensor; //미사용
		gm_OHTStatus->IOInput->uInputCommon.HNAD_Reserved_1                           = gm_OHTStatus->IOInput->uInput.Input_EUV.HNAD_Reserved_1;
		gm_OHTStatus->IOInput->uInputCommon.HOIST_Home_2                              = gm_OHTStatus->IOInput->uInput.Input_EUV.HOIST_Home_2;     // 미사용
		...
		gm_OHTStatus->IOOutput->uOutputCommon.HAND_HandTrigger                             = gm_OHTStatus->IOOutput->uOutput.Output_EUV.HAND_HandTrigger;    //미사용
		...
		gm_OHTStatus->IOOutput->uOutputCommon.EQPIO_CS_2                                   = gm_OHTStatus->IOOutput->uOutput.Output_EUV.EQPIO_CS_2;        //미사용
		gm_OHTStatus->IOOutput->uOutputCommon.EQPIO_CS_3                                   = gm_OHTStatus->IOOutput->uOutput.Output_EUV.EQPIO_CS_3;        //미사용
		...
		gm_OHTStatus->IOOutput->uOutputCommon.EQPIO_Left_Select                            = gm_OHTStatus->IOOutput->uOutput.Output_EUV.EQPIO_Left_Select;      //	BYTE EQPIO_Right_Select; 미사용
		...
		gm_OHTStatus->IOOutput->uOutputCommon.OBSTACLE_Area5_Sel                           = gm_OHTStatus->IOOutput->uOutput.Output_EUV.OBSTACLE_Area5_Sel;     //미사용
		...
		gm_OHTStatus->IOOutput->uOutputCommon.OHTDETECT_Area5_Sel                          = gm_OHTStatus->IOOutput->uOutput.Output_EUV.OHTDETECT_Area5_Sel;    //미사용
		...
		gm_OHTStatus->IOOutput->uOutputCommon.CID_Common_Tag                               = gm_OHTStatus->IOOutput->uOutput.Output_EUV.CID_Common_Tag; 		//동일 lane link 금지
