...
#define HOIST_MOVELIMIT_P           5500          // 기존 레티클이 4000 이었으나 이를 5500으로 늘림
#define HOIST_MOVELIMIT_N           -1.5          // mm
...
#define HOIST_MOVELIMIT_P           5500.0        // mm   3200
...
private:
	...
	*/
    ...
    DWORD m_dwHandDelay_Time;  //V8.5 신률 테스트용 딜레이타임 (핸드 흔들림)
...
public:
	...
	int 	HoistCnt;
	UINT	GetHoistCycleCount(void)		 {return HoistCnt;}
//	int		SlideCnt;
//	UINT	GetSlideCycleCount(void)		 {return SlideCnt;}
	void 	SetCycleCount(int CountUpdate){HoistCnt = CountUpdate;}
	bool 	bHoistJig;
	int     nHoistTeaching;
	int 	m_dHoistHomePos;
