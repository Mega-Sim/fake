...
int HWCommon::MoveDistance(int nAxisNum, DWORD dwTime_Up, DWORD dwTime_Down,
	...
	if (m_pMotionController == NULL)
	{
		ADD_MD_LOG("[TEST] MotionController NULL ");
		return ERR_NO_REAL_HW;
	}
...
//			pMaskOfInput = NULL;
	...
	m_Input.SHUTTER_F_Open = 1;
	m_Input.SHUTTER_R_Open = 1;
...
//	m_Input.CID_Pass_OK_IN = nInData[2][2];
	...
	m_Input.HAND_Open = nInData[0][5];
	m_Input.HAND_Push = nInData[0][6];
	m_Input.Reverved_7 = nInData[0][7];  //m_Input.HOIST_Home = nInData[0][7]; //JIG 대응

	m_Input.HAND_PIO_Go = nInData[0][8];
	m_Input.ROTATE_Inposition = nInData[0][9];  //	m_Input.EQPIO_Load_REQ = nInData[0][9];
	m_Input.ROTATE_Alarm = nInData[0][10];  //	m_Input.EQPIO_Unload_REQ = nInData[0][10];
	m_Input.ROTATE_90 = nInData[0][11];  //	m_Input.EQPIO_Ready = nInData[0][11];
	m_Input.EQPIO_HO_AVBL = nInData[0][12];
	m_Input.EQPIO_ES = nInData[0][13];
	m_Input.EQPIO_Right_Go = nInData[0][14];
	m_Input.EQPIO_Left_Go = nInData[0][15];
	...
	m_Input.STEER_F_Right = nInData[0][18];
	m_Input.STEER_R_Right = nInData[0][19];
	m_Input.SHUTTER_F_Close = 0;
	m_Input.SHUTTER_R_Close = 0;
	m_Input.SHUTTER_F_Open = 1;
	m_Input.SHUTTER_R_Open = 1;
	m_Input.SHUTTER_F_Alarm = nInData[0][24];
	m_Input.SHUTTER_R_Alarm = nInData[0][25];
	...
	m_Input.BCR_Trans_NG = nInData[1][26];
	m_Input.HOIST_Belt_Detect1 = nInData[1][27];
	m_Input.ROTATE_0 = nInData[1][28];		//	m_Input.PIO_Input3 = nInData[1][28];
	m_Input.ROTATE_180 = nInData[1][29];	//	m_Input.PIO_Input5 = nInData[1][29];
	m_Input.ROTATE_270 = nInData[1][30];	//	m_Input.PIO_Input6 = nInData[1][30];
	m_Input.SMPS_Short = nInData[1][31];
	//TG 추가
	m_Input.CID_Link_Compt_IN = nInData[2][0];
	m_Input.CID_Interlock_IN = nInData[2][1];
//	m_Input.CID_Pass_OK_IN = nInData[2][2];
	...
	m_Input.CID_Reserved_IN1 = nInData[2][4];
	m_Input.CID_Reserved_IN2 = nInData[2][5];
	m_Input.Reverved_70 = nInData[2][6];
	m_Input.Reverved_71 = nInData[2][7];
	m_Input.Reverved_72 = nInData[2][8];
	m_Input.Reverved_73 = nInData[2][9];
	m_Input.HOIST_Home = nInData[2][10];//	m_Input.Reverved_74 = nInData[2][10];
	m_Input.Reverved_75 = nInData[2][11];
	m_Input.Reverved_76 = nInData[2][12];
	m_Input.EQPIO_Load_REQ = nInData[2][13];     // IO 차용
	m_Input.EQPIO_Unload_REQ = nInData[2][14];
	m_Input.EQPIO_Ready = nInData[2][15];
...
#elif(OHT_NAME == OHT_NAME_STD_V85)
	{
		...
		m_Input.FAN_Fail 		= nInData[1][16];         //49
...
#elif(OHT_NAME == OHT_NAME_STD_V86)
	{
		...
		m_Input.Reserved_1				 	= nInData[2][21];
		m_Input.Reserved_2				 	= nInData[2][22];
		m_Input.Reserved_3				 	= nInData[2][23];
...
//	m_Output.Outtrigger_R_Speed_OUT = nOutData[2][15];
...
#elif(OHT_NAME == OHT_NAME_STD_V81)        // JIG OUTPUT IO Timy
	m_Output.HAND_Close = nOutData[0][0];
	m_Output.HAND_Open = nOutData[0][1];
	m_Output.HAND_Origin = nOutData[0][2];
	m_Output.HAND_Reset = nOutData[0][3];
	...
	m_Output.HAND_Reserved8 = nOutData[0][7];
	m_Output.HAND_PIO_Select = nOutData[0][8];
	m_Output.ROTATE_0 		= nOutData[0][9];//	m_Output.EQPIO_Valid = nOutData[0][9];
	m_Output.ROTATE_90		= nOutData[0][10];//	m_Output.EQPIO_CS_0 = nOutData[0][10];
	m_Output.ROTATE_180		= nOutData[0][11];//	m_Output.EQPIO_CS_1 = nOutData[0][11];
	m_Output.ROTATE_270		= nOutData[0][12];//	m_Output.EQPIO_CS_2 = nOutData[0][12];
	m_Output.Reserved_14 = nOutData[0][13];//	m_Output.EQPIO_CS_3 = nOutData[0][13];
	m_Output.ROTATE_Origin = nOutData[0][14];//	m_Output.EQPIO_TR_Req = nOutData[0][14];
	m_Output.ROTATE_Alarm_Reset = nOutData[0][15];//	m_Output.EQPIO_Busy = nOutData[0][15];
	m_Output.ROTATE_Free = nOutData[0][16];//	m_Output.EQPIO_Complete = nOutData[0][16];
	m_Output.EQPIO_Left_Select = nOutData[0][17];
	m_Output.EQPIO_Right_Select = nOutData[0][18];
	m_Output.STEER_F_TRQ_0 = nOutData[0][19];
...
//	m_Output.CID_PASS_Compt_OUT = nOutData[2][3];
	...
	m_Output.CID_Common_Tag = nOutData[2][6];
	m_Output.CID_Reserved_OUT2 = nOutData[2][7];
	m_Output.EQPIO_Valid = nOutData[2][8];           // IO 차용
	m_Output.EQPIO_CS_0 = nOutData[2][9];
	m_Output.EQPIO_CS_1 = nOutData[2][10];
	m_Output.EQPIO_CS_2 = nOutData[2][11];
	m_Output.EQPIO_CS_3 = nOutData[2][12];
	m_Output.EQPIO_TR_Req = nOutData[2][13];
	m_Output.EQPIO_Busy = nOutData[2][14];
	m_Output.EQPIO_Complete = nOutData[2][15];
...
void HWCommon::Set_Jig(int n, bool bUse)
{
	 m_pMotionController->Set_Jig(n, bUse);
}

void HWCommon::Axis_Ignore(bool bUse)
{
	 m_pMotionController->Axis_Ignore(bUse);
}
