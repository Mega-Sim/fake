...
typedef struct sINPUTV81_
{
	...
	BYTE HAND_Open;
	BYTE HAND_Push;
	BYTE Reverved_7;	//	BYTE HOIST_Home;
	BYTE HAND_PIO_Go;    // 8
	BYTE ROTATE_Inposition; // 9 	//	BYTE EQPIO_Load_REQ;
	BYTE ROTATE_Alarm;// 10 //	BYTE EQPIO_Unload_REQ;
	BYTE ROTATE_90;//11    //	BYTE EQPIO_Ready;
	BYTE EQPIO_HO_AVBL;
	BYTE EQPIO_ES;
	BYTE EQPIO_Right_Go;
	BYTE EQPIO_Left_Go;
	BYTE STEER_F_Left;         	//16
	BYTE STEER_R_Left;
	BYTE STEER_F_Right;
	BYTE STEER_R_Right;
	BYTE SHUTTER_F_Close;
	...
	BYTE OBSTACLE_Middle;
	BYTE OBSTACLE_Short;
	BYTE OBSTACLE_Fail;          //31

	BYTE OHTDETECT_Long;          //32
	BYTE OHTDETECT_Middle;
	BYTE OHTDETECT_Short;
	BYTE OHTDETECT_Fail;
	BYTE LOOKDOWN_Detect;
	...
	BYTE BCR_Trans_NG;
	BYTE HOIST_Belt_Detect1;
	BYTE ROTATE_0;	 //60	//BYTE PIO_Input3;
	BYTE ROTATE_180; //61	//BYTE PIO_Input5;
	BYTE ROTATE_270; //62	//BYTE PIO_Input6;
	BYTE SMPS_Short;                   //63
	//TG 추가
	BYTE CID_Link_Compt_IN;            //64
	BYTE CID_Interlock_IN;
	BYTE CID_Completion_ACK;
	BYTE CID_Status_IN;
	BYTE CID_Reserved_IN1;
	...
	BYTE Reverved_72;
	BYTE Reverved_73;
	BYTE HOIST_Home;	 //74	//	BYTE Reverved_74;
	BYTE Reverved_75;
	BYTE Reverved_76;
	BYTE EQPIO_Load_REQ;          	// IO 차용
	BYTE EQPIO_Unload_REQ;
	BYTE EQPIO_Ready;
...
typedef struct sOUTPUTV81_
{
	...
	BYTE HAND_PIO_Select;
	BYTE ROTATE_0;
	BYTE ROTATE_90; //BYTE EQPIO_Valid;

	//11 ~ 20
	BYTE ROTATE_180; //BYTE EQPIO_CS_0;
	BYTE ROTATE_270; //BYTE EQPIO_CS_1;
	BYTE Reserved_14;	//BYTE EQPIO_CS_2;
	BYTE ROTATE_Origin; //BYTE EQPIO_CS_3;
	BYTE ROTATE_Alarm_Reset; //BYTE EQPIO_TR_Req;
	BYTE ROTATE_Free; //BYTE EQPIO_Busy;
	//BYTE EQPIO_Complete;
	BYTE EQPIO_Left_Select;
	BYTE EQPIO_Right_Select;
	BYTE STEER_F_TRQ_0;
...
#elif(OHT_NAME == OHT_NAME_STD_V81)         // JIG OUPUT IO timy
enum OUTPUT
{
	OUT_HAND_CLOSE = 0,         // 0
	OUT_HAND_OPEN,
	...
	OUT_HAND_RESERVED8,
	OUT_HAND_PIO_SEL,
	OUT_ROTATE_0,	//	OUT_EQPIO_VALID,            // 9
	OUT_ROTATE_90,	//	OUT_EQPIO_CS_0,             // 10
	OUT_ROTATE_180,	//	OUT_EQPIO_CS_1,
	OUT_ROTATE_270,	//	OUT_EQPIO_CS_2,
	OUT_RESERVED_14,	//	OUT_EQPIO_CS_3,
	OUT_ROTATE_ORIGIN,	//OUT_EQPIO_TR_REQ,
	OUT_ROTATE_ALARM_RESET,//OUT_EQPIO_BUSY, 		 //15
	OUT_ROTATE_FREE, //OUT_EQPIO_COMPLETE,
	OUT_EQPIO_RIGHT_SEL,
	OUT_EQPIO_LEFT_SEL,
	OUT_STEER_F_TRQ_0,
	OUT_STEER_F_TRQ_1,
...
enum OUTPUT
{
	...
	OUT_CID_Operation_Mode,
	OUT_CID_Common_Tag,
	OUT_CID_Reserved_OUT2,    // AOHC-279
...
//---------------------------------------------------------------------------
// Rotate Unit 관련 Define
#define	ROTATE_NO_COMMAND		    0
#define	ROTATE_0_COMMAND			1
#define	ROTATE_90_COMMAND 		    2
#define	ROTATE_180_COMMAND 		    3
#define	ROTATE_270_COMMAND 		    4
#define	ROTATE_ORIGIN_COMMAND	    5
#define	ROTATE_RESET_COMMAND		    6
#define	ROTATE_ORIGIN_LIMIT_TIME	30000
#define	ROTATE_MOTION_LIMIT_TIME	12000
//---------------------------------------------------------------------------
