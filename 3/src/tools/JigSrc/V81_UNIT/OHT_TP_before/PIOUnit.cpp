...
//		shpGoRight->Brush->Color = (gm_OHTStatus->IOInput->uInput.InputV70_R01.EQPIO_Right_Go==1) ? COLOR_BLUE : COLOR_WHITE;
	   ...
	   // shapCS1->Brush->Color = (gm_OHTStatus->IOOutput->uOutput.Output_EUV.EQPIO_CS_1==1) ? COLOR_RED : COLOR_WHITE;
