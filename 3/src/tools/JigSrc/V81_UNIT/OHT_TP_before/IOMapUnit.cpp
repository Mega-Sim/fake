...
void TIOMapForm::InitIOMap(IO_MAP_FIELD* m_pIOMapField)
{
    ...
    strgridUseOnOff->Cells[Col][USE_SET_CROSSRAILINTERLOCK] = "Use CrossRail Interlock";
    ...
    if(IOMapForm->Visible == true)
	{
        ...
        case 2: // Check On/OFF
            ...
            strgridUseOnOff->Cells[k][j++] = (gm_OHTStatus->CheckOnOff->bUse_PushAbnormalOnCheck == true) ?
                "ON" : "OFF";
            strgridUseOnOff->Cells[k][j++] = (gm_OHTStatus->CheckOnOff->bUse_CrossRail_Interlock == true) ?
                "ON" : "OFF";
