...
__published: // IDE-managed Components
    ...
    TPanel *panAutoTeaching;
    TLabel *Label2;
    TButton *btnATConnect;
    TButton *btnATRead;
    TButton *btnATMove;
    TButton *btnATReadMove;
    TEdit *edIP;
    TButton *btnATDiscon;
    TButton *btn12mmUp;
    TButton *btn12mmDown;
	...
	TEdit *edtPIOID;
	TEdit *edtPIOChannel;
	TButton *btnTeachStart;
	TButton *btnTeachStop;
	TLabel *Label14;
	TEdit *edtTeaching;
	TComboBox *cboParam;
	TButton *Button1;
    ...
    void __fastcall btnATConnectClick(TObject *Sender);
    void __fastcall btnATDisconClick(TObject *Sender);
    void __fastcall btn12mmUpClick(TObject *Sender);
    void __fastcall btn12mmDownClick(TObject *Sender);
    void __fastcall btnATReadClick(TObject *Sender);
    void __fastcall btnATMoveClick(TObject *Sender);
    void __fastcall btnATReadMoveClick(TObject *Sender);
	...
	void __fastcall btnTeachStartClick(TObject *Sender);
	void __fastcall btnTeachStopClick(TObject *Sender);
